!function (e, t) {
    ...
    return function (e) {
        ...
        "use strict";
        (function (e) {
            const s = t.Package = i(60), {Error: n, RangeError: r} = i(3), o = t.browser = "undefined" != typeof window;
            t.DefaultOptions = {
                shardCount: 1,
            ...
            }, t.UserAgent = o ? null : `DiscordBot (${s.homepage.split("#")[0]}, ${s.version}) Node.js/${e.version}`, t.WSCodes = {
            ...
            const a = ["webp", "png", "jpg", "jpeg", "gif"], c = Array.from({length: 9}, (e, t) => 2 ** (t + 4));

            function l(e, {format: t = "webp", size: i} = {}) {
                if (t && !a.includes(t)) throw new n("IMAGE_FORMAT", t);
                if (i && !c.includes(i)) throw new r("IMAGE_SIZE", i);
                return `${e}.${t}${i ? "?size=" + i : ""}`
            }
            ...
            t.Endpoints = {
                CDN: e => ({
                    Emoji: (t, i = "png") => `${e}/emojis/${t}.${i}`,
                    Asset: t => `${e}/assets/${t}`,
                    DefaultAvatar: t => `${e}/embed/avatars/${t}.png`,
                    Avatar: (t, i, s = "webp", n, r = !1) => (r && (s = i.startsWith("a_") ? "gif" : s), l(`${e}/avatars/${t}/${i}`, {
                        format: s,
                        size: n
                    })),
                    Banner: (t, i, s = "webp", n) => l(`${e}/banners/${t}/${i}`, {format: s, size: n}),
                    Icon: (t, i, s = "webp", n, r = !1) => (r && (s = i.startsWith("a_") ? "gif" : s), l(`${e}/icons/${t}/${i}`, {
                        format: s,
                        size: n
                    })),
                    AppIcon: (t, i, {format: s = "webp", size: n} = {}) => l(`${e}/app-icons/${t}/${i}`, {
                        size: n,
                        format: s
                    }),
                    AppAsset: (t, i, {format: s = "webp", size: n} = {}) => l(`${e}/app-assets/${t}/${i}`, {
                        size: n,
                        format: s
                    }),
                    GDMIcon: (t, i, s = "webp", n) => l(`${e}/channel-icons/${t}/${i}`, {size: n, format: s}),
                    Splash: (t, i, s = "webp", n) => l(`${e}/splashes/${t}/${i}`, {size: n, format: s}),
                    DiscoverySplash: (t, i, s = "webp", n) => l(`${e}/discovery-splashes/${t}/${i}`, {
                        size: n,
                        format: s
                    }),
                    TeamIcon: (t, i, {format: s = "webp", size: n} = {}) => l(`${e}/team-icons/${t}/${i}`, {
                        size: n,
                        format: s
                    })
        ...
        e.exports = class GenericAction {
            ...
            getPayload(e, t, i, s, n) {
                ...
                return !r && this.client.options.partials.includes(s) ? t.add(e, n) : r
            }
            ...
            getChannel(e) {
                ...
                }, this.client.channels, t, s.CHANNEL)
            }
            ...
            getReaction(e, t, i) {
                ...
                return this.getPayload({
                    ...
                    me: !!i && i.id === this.client.user.id
                }, t.reactions, n, s.REACTION)
            }

            getMember(e, t) {
                const i = e.user.id;
                return this.getPayload({user: {id: i}}, t.members, i, s.GUILD_MEMBER)
            }

            getUser(e) {
                const t = e.user_id;
                return e.user || this.getPayload({id: t}, this.client.users, t, s.USER)
            }
        }
    }, function (e, t, i) {
        "use strict";
        const s = i(103), n = i(4);
        e.exports = class Collection extends s {
            toJSON() {
        ...
        "use strict";
        e.exports = i(61), e.exports.Messages = i(102)
    }, function (e, t, i) {
        "use strict";
        (function (t) {
            const {parse: s} = i(36),
                n = i(37), {Colors: r, DefaultOptions: o, Endpoints: a} = i(0), {Error: c, RangeError: l, TypeError: h} = i(3),
            ...
            class Util {
                ...
                static flatten(e, ...t) {
                    ...
                    for (let [n, r] of Object.entries(t)) {
                        ...
                        t instanceof i(2) ? s[r] = Array.from(t.keys()) : a instanceof i(2) ? s[r] = Array.from(a.keys()) : Array.isArray(t) ? s[r] = t.map(e => Util.flatten(e)) : "object" != typeof a ? s[r] = a : o || (s[r] = t)
                    }
                    return s
                }

                static splitMessage(e, {maxLength: t = 2e3, char: i = "\n", prepend: s = "", append: n = ""} = {}) {
                    if ((e = Util.resolveString(e)).length <= t) return [e];
                    const r = e.split(i);
                    if (r.some(e => e.length > t)) throw new l("SPLIT_MAX_LEN");
                    const o = [];
                    let a = "";
                    for (const e of r) a && (a + i + e + n).length > t && (o.push(a + n), a = s), a += (a && a !== s ? i : "") + e;
                    return o.concat(a).filter(e => e)
                }

                static escapeMarkdown(e, {codeBlock: t = !0, inlineCode: i = !0, bold: s = !0, italic: n = !0, underline: r = !0, strikethrough: o = !0, spoiler: a = !0, codeBlockContent: c = !0, inlineCodeContent: l = !0} = {}) {
                    return c ? l ? (i && (e = Util.escapeInlineCode(e)), t && (e = Util.escapeCodeBlock(e)), n && (e = Util.escapeItalic(e)), s && (e = Util.escapeBold(e)), r && (e = Util.escapeUnderline(e)), o && (e = Util.escapeStrikethrough(e)), a && (e = Util.escapeSpoiler(e)), e) : e.split(/(?<=^|[^`])`(?=[^`]|$)/g).map((e, i, c) => i % 2 && i !== c.length - 1 ? e : Util.escapeMarkdown(e, {
                        codeBlock: t,
                        bold: s,
                        italic: n,
                        underline: r,
                        strikethrough: o,
                        spoiler: a
                    })).join(i ? "\\`" : "`") : e.split("```").map((e, t, c) => t % 2 && t !== c.length - 1 ? e : Util.escapeMarkdown(e, {
                        inlineCode: i,
                        bold: s,
                        italic: n,
                        underline: r,
                ...
                static escapeItalic(e) {
                    let t = 0;
                    return e = e.replace(/(?<=^|[^*])\*([^*]|\*\*|$)/g, (e, i) => "**" === i ? ++t % 2 ? "\\*" + i : i + "\\*" : "\\*" + i), t = 0, e.replace(/(?<=^|[^_])_([^_]|__|$)/g, (e, i) => "__" === i ? ++t % 2 ? "\\_" + i : i + "\\_" : "\\_" + i)
                }

                static escapeBold(e) {
                    let t = 0;
                    return e.replace(/\*\*(\*)?/g, (e, i) => i ? ++t % 2 ? i + "\\*\\*" : "\\*\\*" + i : "\\*\\*")
                }

                static escapeUnderline(e) {
                    let t = 0;
                    return e.replace(/__(_)?/g, (e, i) => i ? ++t % 2 ? i + "\\_\\_" : "\\_\\_" + i : "\\_\\_")
                }
                ...
                static mergeDefault(e, t) {
                    if (!t) return e;
                    for (const n in e) i = t, s = n, Object.prototype.hasOwnProperty.call(i, s) && void 0 !== t[n] ? t[n] === Object(t[n]) && (t[n] = Util.mergeDefault(e[n], t[n])) : t[n] = e[n];
                    var i, s;
                    return t
                }

                static convertToBuffer(e) {
                    return "string" == typeof e && (e = Util.str2ab(e)), t.from(e)
                }

                static str2ab(e) {
                    const t = new ArrayBuffer(2 * e.length), i = new Uint16Array(t);
                    for (var s = 0, n = e.length; s < n; s++) i[s] = e.charCodeAt(s);
                    return t
                }
                ...
                static moveElementInArray(e, t, i, s = !1) {
                    const n = e.indexOf(t);
                    if ((i = (s ? n : 0) + i) > -1 && i < e.length) {
                ...
                static setPosition(e, t, i, s, n, r) {
                    let o = s.array();
                    return Util.moveElementInArray(o, e, t, i), o = o.map((e, t) => ({
                        id: e.id,
                        position: t
                ...
                static idToBinary(e) {
                    let t = "", i = parseInt(e.slice(0, -10)) || 0, s = parseInt(e.slice(-10));
                    for (; s > 0 || i > 0;) t = String(1 & s) + t, s = Math.floor(s / 2), i > 0 && (s += i % 2 * 5e9, i = Math.floor(i / 2));
                    return t
                }
                ...
                static binaryToID(e) {
                    let t = "";
                    for (; e.length > 50;) {
                        const i = parseInt(e.slice(0, -32), 2), s = parseInt((i % 10).toString(2) + e.slice(-32), 2);
                        t = (s % 10).toString() + t, e = Math.floor(i / 10).toString(2) + Math.floor(s / 10).toString(2).padStart(32, "0")
                    }
                ...
                static cleanContent(e, t) {
                    return e = e.replace(/<@!?[0-9]+>/g, e => {
                        ...
                        if ("dm" === t.channel.type) {
                            const s = t.client.users.cache.get(i);
                            return s ? "@" + s.username : e
                        }
                        const s = t.channel.guild.members.cache.get(i);
                        ...
                        const i = t.client.channels.cache.get(e.replace(/<|#|>/g, ""));
                        return i ? "#" + i.name : e
                    }).replace(/<@&[0-9]+>/g, e => {
                        if ("dm" === t.channel.type) return e;
                        const i = t.guild.roles.cache.get(e.replace(/<|@|>|&/g, ""));
                        return i ? "@" + i.name : e
        ...
        e.exports = class BaseManager {
            constructor(e, t, r, o = s, ...a) {
                if (n || (n = i(24)), Object.defineProperty(this, "holds", {value: n.get(r.name) || r}), Object.defineProperty(this, "client", {value: e}), this.cacheType = o, this.cache = new o(...a), t) for (const e of t) this.add(e)
            }

            add(e, t = !0, {id: i, extras: s = []} = {}) {
                const n = this.cache.get(i || e.id);
                if (n && n._patch && t && n._patch(e), n) return n;
                const r = this.holds ? new this.holds(this.client, e, ...s) : e;
                return t && this.cache.set(i || r.id, r), r
            }
        ...
        e.exports = class SnowflakeUtil {
            ...
            static generate(e = Date.now()) {
                ...
                return s.binaryToID(t)
            }

            static deconstruct(e) {
                const t = s.idToBinary(e).toString(2).padStart(64, "0"), i = {
                ...
                return Object.defineProperty(i, "date", {
                    get: function () {
        ...
        "use strict";
        (function (t) {
            const s = i(36), n = i(36), r = i(123), o = i(37), {Error: a, TypeError: c} = i(3), {browser: l} = i(0),
                h = i(4);
            ...
            class DataResolver {
                ...
                static async resolveImage(e) {
                    ...
                    const t = await this.resolveFileAsBuffer(e);
                    return DataResolver.resolveBase64(t)
                }

                static resolveBase64(e) {
                    return t.isBuffer(e) ? "data:image/jpg;base64," + e.toString("base64") : e
                }

                static async resolveFile(e) {
                    if (!l && t.isBuffer(e)) return e;
                    if (l && e instanceof ArrayBuffer) return h.convertToBuffer(e);
                    if (e instanceof r.Readable) return e;
                    if ("string" == typeof e) {
                        if (/^https?:\/\//.test(e)) {
                            const t = await o(e);
                            return l ? t.blob() : t.body
                        }
                        if (!l) return new Promise((t, i) => {
                            const r = n.resolve(e);
                            s.stat(r, (e, n) => e ? i(e) : n.isFile() ? t(s.createReadStream(r)) : i(new a("FILE_NOT_FOUND", r)))
                        })
                    }
                    throw new c("REQ_RESOURCE_TYPE")
                }

                static async resolveFileAsBuffer(e) {
                    const i = await this.resolveFile(e);
                    if (t.isBuffer(i)) return i;
                    const s = [];
                    for await(const e of i) s.push(e);
                    return t.concat(s)
                }
            }
        ...
        "use strict";
        const s = i(5), {Presence: n} = i(13), r = i(19), o = i(28), a = i(34), {Error: c} = i(3), l = i(73), h = i(8);

        class GuildMember extends s {
            constructor(e, t, i) {
                super(e), this.guild = i, t.user && (this.user = e.users.add(t.user, !0)), this.joinedTimestamp = null, this.lastMessageID = null, this.lastMessageChannelID = null, this.premiumSinceTimestamp = null, this.deleted = !1, this._roles = [], t && this._patch(t)
            }
            ...
            hasPermission(e, {checkAdmin: t = !0, checkOwner: i = !0} = {}) {
                return !(!i || this.user.id !== this.guild.ownerID) || this.roles.cache.some(i => i.permissions.has(e, t))
            }
            ...
            async edit(e, t) {
                ...
                let i = this.client.api.guilds(this.guild.id);
                if (this.user.id === this.client.user.id) {
                    const t = Object.keys(e);
                    i = 1 === t.length && "nick" === t[0] ? i.members("@me").nick : i.members(this.id)
                } else i = i.members(this.id);
                await i.patch({data: e, reason: t});
                const s = this._clone();
                return e.user = this.user, s._patch(e), s
            }
        ...
        class BitField {
            ...
            add(...e) {
                let t = 0;
                for (const i of e) t |= this.constructor.resolve(i);
            ...
            serialize(...e) {
                const t = {};
                for (const [i, s] of Object.entries(this.constructor.FLAGS)) t[i] = this.has(s, ...e);
                return t
            }
        ...
        "use strict";
        const s = i(31), n = i(16), {WebhookTypes: r} = i(0), o = i(9), a = i(7);
        ...
        class Webhook {
            ...
            async send(e, t) {
                let i;
                if (e instanceof s) i = e.resolveData(); else if (i = s.create(this, e, t).resolveData(), Array.isArray(i.data.content)) return Promise.all(i.split().map(this.send.bind(this)));
                const {data: n, files: r} = await i.resolveFiles();
            ...
            async edit({name: e = this.name, avatar: t, channel: i}, s) {
                t && "string" == typeof t && !t.startsWith("data:") && (t = await o.resolveImage(t)), i && (i = i instanceof n ? i.id : i);
                const r = await this.client.api.webhooks(this.id, i ? void 0 : this.token).patch({
                    data: {
                        name: e,
                        avatar: t,
                        channel_id: i
        ...
        "use strict";
        const s = i(30), n = i(71), {ActivityTypes: r} = i(0), o = i(4);
        ...
        class Activity {
            constructor(e, t) {
                ...
                } : null, this.party = t.party || null, this.assets = t.assets ? new RichPresenceAssets(this, t.assets) : null, this.syncID = t.sync_id, this.flags = new n(t.flags).freeze(), this.emoji = t.emoji ? new s(e.client, t.emoji) : null, this.createdTimestamp = new Date(t.created_at).getTime()
            }
        ...
        t.Presence = class Presence {
            ...
            equals(e) {
                return this === e || e && this.status === e.status && this.activities.length === e.activities.length && this.activities.every((t, i) => t.equals(e.activities[i])) && this.clientStatus.web === e.clientStatus.web && this.clientStatus.mobile === e.clientStatus.mobile && this.clientStatus.desktop === e.clientStatus.desktop
            }
        ...
        n.nextTick = function (e) {
            ...
            l.push(new f(e, t)), 1 !== l.length || h || a(p)
        ...
        "use strict";
        var s, n = "object" == typeof Reflect ? Reflect : null,
            r = n && "function" == typeof n.apply ? n.apply : function (e, t, i) {
                return Function.prototype.apply.call(e, t, i)
            };
        s = n && "function" == typeof n.ownKeys ? n.ownKeys : Object.getOwnPropertySymbols ? function (e) {
        ...
        function u(e, t, i, s) {
            var n, r, o, a;
            if (l(i), void 0 === (r = e._events) ? (r = e._events = Object.create(null), e._eventsCount = 0) : (void 0 !== r.newListener && (e.emit("newListener", t, i.listener ? i.listener : i), r = e._events), o = r[t]), void 0 === o) o = r[t] = i, ++e._eventsCount; else if ("function" == typeof o ? o = r[t] = s ? [i, o] : [o, i] : s ? o.unshift(i) : o.push(i), (n = h(e)) > 0 && o.length > n && !o.warned) {
                o.warned = !0;
        ...
        function p(e, t, i) {
            var s = {fired: !1, wrapFn: void 0, target: e, type: t, listener: i}, n = d.bind(s);
        ...
        Object.defineProperty(a, "defaultMaxListeners", {
            ...
            var i, s, n, r, o;
            if (l(t), void 0 === (s = this._events)) return this;
            if (void 0 === (i = s[e])) return this;
            if (i === t || i.listener === t) 0 == --this._eventsCount ? this._events = Object.create(null) : (delete s[e], s.removeListener && this.emit("removeListener", e, i.listener || t)); else if ("function" != typeof i) {
                ...
                0 === n ? i.shift() : function (e, t) {
                    ...
                    e.pop()
                }(i, n), 1 === i.length && (s[e] = i[0]), void 0 !== s.removeListener && this.emit("removeListener", e, o || t)
            }
            return this
            ...
            if ("function" == typeof (t = i[e])) this.removeListener(e, t); else if (void 0 !== t) for (s = t.length - 1; s >= 0; s--) this.removeListener(e, t[s]);
            return this
        ...
        "use strict";
        const s = i(5), {ChannelTypes: n} = i(0), r = i(7);
        e.exports = class Channel extends s {
            constructor(e, t) {
                super(e);
                const i = Object.keys(n)[t.type];
                this.type = i ? i.toLowerCase() : "unknown", this.deleted = !1, t && this._patch(t)
            }
            ...
            static create(e, t, s) {
                ...
                let o;
                if (t.guild_id || s) {
                    if (s = s || e.guilds.cache.get(t.guild_id)) {
                        switch (t.type) {
                            case n.TEXT:
                                o = new (r.get("TextChannel"))(s, t);
                                break;
                            case n.VOICE:
                                o = new (r.get("VoiceChannel"))(s, t);
                                break;
                            case n.CATEGORY:
                                o = new (r.get("CategoryChannel"))(s, t);
                                break;
                            case n.NEWS:
                                o = new (r.get("NewsChannel"))(s, t);
                                break;
                            case n.STORE:
                                o = new (r.get("StoreChannel"))(s, t);
                                break
                        }
                        o && s.channels.cache.set(o.id, o)
                    }
        ...
        "use strict";
        const s = i(16), n = i(18), r = i(43), o = i(19), {Error: a, TypeError: c} = i(3), l = i(2), h = i(8), u = i(4);
        e.exports = class GuildChannel extends s {
            constructor(e, t) {
            ...
            get permissionsLocked() {
                return this.parent ? this.permissionOverwrites.size === this.parent.permissionOverwrites.size && this.permissionOverwrites.every((e, t) => {
                    const i = this.parent.permissionOverwrites.get(t);
                    return void 0 !== i && i.deny.bitfield === e.deny.bitfield && i.allow.bitfield === e.allow.bitfield
                }) : null
            }
            ...
            permissionsFor(e) {
                ...
                const i = this.guild.roles.resolve(e);
                return i ? this.rolePermissions(i) : null
            }

            overwritesFor(e, t = !1, i = null) {
                if (t || (e = this.guild.members.resolve(e)), !e) return [];
                i = i || e.roles.cache;
                const s = [];
                let n, r;
                for (const t of this.permissionOverwrites.values()) t.id === this.guild.id ? r = t : i.has(t.id) ? s.push(t) : t.id === e.id && (n = t);
                return {everyone: r, roles: s, member: n}
            }

            memberPermissions(e) {
                if (e.id === this.guild.ownerID) return new h(h.ALL).freeze();
                const t = e.roles.cache, i = new h(t.map(e => e.permissions));
                if (i.has(h.FLAGS.ADMINISTRATOR)) return new h(h.ALL).freeze();
                const s = this.overwritesFor(e, !0, t);
                return i.remove(s.everyone ? s.everyone.deny : 0).add(s.everyone ? s.everyone.allow : 0).remove(s.roles.length > 0 ? s.roles.map(e => e.deny) : 0).add(s.roles.length > 0 ? s.roles.map(e => e.allow) : 0).remove(s.member ? s.member.deny : 0).add(s.member ? s.member.allow : 0).freeze()
            }

            rolePermissions(e) {
                if (e.permissions.has(h.FLAGS.ADMINISTRATOR)) return new h(h.ALL).freeze();
                const t = this.permissionOverwrites.get(this.guild.id), i = this.permissionOverwrites.get(e.id);
                return e.permissions.remove(t ? t.deny : 0).add(t ? t.allow : 0).remove(i ? i.deny : 0).add(i ? i.allow : 0).freeze()
            }
            ...
            updateOverwrite(e, t, i) {
                if (!(e = this.guild.roles.resolve(e) || this.client.users.resolve(e))) return Promise.reject(new c("INVALID_TYPE", "parameter", "User nor a Role"));
                const s = this.permissionOverwrites.get(e.id);
                return s ? s.update(t, i).then(() => this) : this.createOverwrite(e, t, i)
            }

            createOverwrite(e, t, i) {
                if (!(e = this.guild.roles.resolve(e) || this.client.users.resolve(e))) return Promise.reject(new c("INVALID_TYPE", "parameter", "User nor a Role"));
                const s = e instanceof o ? "role" : "member", {allow: n, deny: a} = r.resolveOverwriteOptions(t);
            ...
            async edit(e, t) {
                ...
                const i = e.permissionOverwrites && e.permissionOverwrites.map(e => r.resolve(e, this.guild)),
                    s = await this.client.api.channels(this.id).patch({
                        data: {
            ...
            setParent(e, {lockPermissions: t = !0, reason: i} = {}) {
                return this.edit({
            ...
            setPosition(e, {relative: t, reason: i} = {}) {
                return u.setPosition(this, e, t, this.guild._sortedChannels(this), this.client.api.guilds(this.guild.id).channels, i).then(e => (this.client.actions.GuildChannelsPositionUpdate.handle({
                    guild_id: this.guild.id,
                    channels: e
                }), this))
            }

            createInvite({temporary: e = !1, maxAge: t = 86400, maxUses: i = 0, unique: s, reason: r} = {}) {
        ...
        "use strict";
        const s = i(5), {Endpoints: n} = i(0), r = i(8);
        e.exports = class Invite extends s {
            constructor(e, t) {
        ...
        "use strict";
        const s = i(5), {Error: n, TypeError: r} = i(3), o = i(8), a = i(7), c = i(4);
        e.exports = class Role extends s {
            constructor(e, t, i) {
                super(e), this.guild = i, t && this._patch(t)
            }
            ...
            setPosition(e, {relative: t, reason: i} = {}) {
                return c.setPosition(this, e, t, this.guild._sortedRoles(), this.client.api.guilds(this.guild.id).roles, i).then(e => (this.client.actions.GuildRolesPositionUpdate.handle({
                    guild_id: this.guild.id,
                    roles: e
                }), this))
            }
        ...
        "use strict";
        var s = i(32), n = Object.keys || function (e) {
            var t = [];
            for (var i in e) t.push(i);
            return t
        };
        e.exports = u;
        var r = Object.create(i(26));
        r.inherits = i(23);
        var o = i(66), a = i(47);
        r.inherits(u, o);
        for (var c = n(a.prototype), l = 0; l < c.length; l++) {
            var h = c[l];
        ...
        function u(e) {
            ...
            o.call(this, e), a.call(this, e), e && !1 === e.readable && (this.readable = !1), e && !1 === e.writable && (this.writable = !1), this.allowHalfOpen = !0, e && !1 === e.allowHalfOpen && (this.allowHalfOpen = !1), this.once("end", d)
        }

        function d() {
            this.allowHalfOpen || this._writableState.ended || s.nextTick(p, this)
        }
        ...
        (function (e) {
            ...
            function l(e, t, i, s) {
                ...
                return "undefined" != typeof ArrayBuffer && t instanceof ArrayBuffer ? function (e, t, i, s) {
                    if (t.byteLength, i < 0 || t.byteLength < i) throw new RangeError("'offset' is out of bounds");
                    if (t.byteLength < i + (s || 0)) throw new RangeError("'length' is out of bounds");
                    t = void 0 === i && void 0 === s ? new Uint8Array(t) : void 0 === s ? new Uint8Array(t, i) : new Uint8Array(t, i, s);
                    c.TYPED_ARRAY_SUPPORT ? (e = t).__proto__ = c.prototype : e = d(e, t);
                    return e
                }(e, t, i, s) : "string" == typeof t ? function (e, t, i) {
                    "string" == typeof i && "" !== i || (i = "utf8");
                    if (!c.isEncoding(i)) throw new TypeError('"encoding" must be a valid string encoding');
                    var s = 0 | f(t, i), n = (e = a(e, s)).write(t, i);
                    n !== s && (e = e.slice(0, n));
                    return e
                }(e, t, i) : function (e, t) {
                    if (c.isBuffer(t)) {
            ...
            function u(e, t) {
                if (h(t), e = a(e, t < 0 ? 0 : 0 | p(t)), !c.TYPED_ARRAY_SUPPORT) for (var i = 0; i < t; ++i) e[i] = 0;
                return e
            }
            ...
            function d(e, t) {
                ...
                e = a(e, i);
                for (var s = 0; s < i; s += 1) e[s] = 255 & t[s];
                return e
            }
            ...
            function E(e, t, i, s, n) {
                ...
                if ("string" == typeof i ? (s = i, i = 0) : i > 2147483647 ? i = 2147483647 : i < -2147483648 && (i = -2147483648), i = +i, isNaN(i) && (i = n ? 0 : e.length - 1), i < 0 && (i = e.length + i), i >= e.length) {
                    if (n) return -1;
                    i = e.length - 1
                } else if (i < 0) {
                    if (!n) return -1;
                ...
                if ("string" == typeof t && (t = c.from(t, s)), c.isBuffer(t)) return 0 === t.length ? -1 : _(e, t, i, s, n);
                if ("number" == typeof t) return t &= 255, c.TYPED_ARRAY_SUPPORT && "function" == typeof Uint8Array.prototype.indexOf ? n ? Uint8Array.prototype.indexOf.call(e, t, i) : Uint8Array.prototype.lastIndexOf.call(e, t, i) : _(e, [t], i, s, n);
                throw new TypeError("val must be string, number or Buffer")
            }

            function _(e, t, i, s, n) {
                var r, o = 1, a = e.length, c = t.length;
                ...
                if (n) {
                    var h = -1;
                    for (r = i; r < a; r++) if (l(e, r) === l(t, -1 === h ? 0 : r - h)) {
                        if (-1 === h && (h = r), r - h + 1 === c) return h * o
                    } else -1 !== h && (r -= r - h), h = -1
                } else for (i + c > a && (i = a - c), r = i; r >= 0; r--) {
                    for (var u = !0, d = 0; d < c; d++) if (l(e, r + d) !== l(t, d)) {
                        u = !1;
                        break
                    }
                    if (u) return r
            ...
            function S(e, t, i, s) {
                return H(function (e, t) {
                    for (var i, s, n, r = [], o = 0; o < e.length && !((t -= 2) < 0); ++o) i = e.charCodeAt(o), s = i >> 8, n = i % 256, r.push(n), r.push(s);
                    return r
                }(t, e.length - i), e, i, s)
            }
            ...
            function T(e, t, i) {
                ...
                for (var s = [], n = t; n < i;) {
                    var r, o, a, c, l = e[n], h = null, u = l > 239 ? 4 : l > 223 ? 3 : l > 191 ? 2 : 1;
                    if (n + u <= i) switch (u) {
                        case 1:
                            l < 128 && (h = l);
                            break;
                        case 2:
                            128 == (192 & (r = e[n + 1])) && (c = (31 & l) << 6 | 63 & r) > 127 && (h = c);
                            break;
                        case 3:
                            r = e[n + 1], o = e[n + 2], 128 == (192 & r) && 128 == (192 & o) && (c = (15 & l) << 12 | (63 & r) << 6 | 63 & o) > 2047 && (c < 55296 || c > 57343) && (h = c);
                            break;
                        case 4:
                            r = e[n + 1], o = e[n + 2], a = e[n + 3], 128 == (192 & r) && 128 == (192 & o) && 128 == (192 & a) && (c = (15 & l) << 18 | (63 & r) << 12 | (63 & o) << 6 | 63 & a) > 65535 && c < 1114112 && (h = c)
                    }
                    null === h ? (h = 65533, u = 1) : h > 65535 && (h -= 65536, s.push(h >>> 10 & 1023 | 55296), h = 56320 | 1023 & h), s.push(h), n += u
                }
                return function (e) {
                    var t = e.length;
                    if (t <= 4096) return String.fromCharCode.apply(String, e);
                    var i = "", s = 0;
                    for (; s < t;) i += String.fromCharCode.apply(String, e.slice(s, s += 4096));
                    return i
                }(s)
            }
            ...
            t.Buffer = c, t.SlowBuffer = function (e) {
                ...
                return function (e, t, i, s) {
                    return h(t), t <= 0 ? a(e, t) : void 0 !== i ? "string" == typeof s ? a(e, t).fill(i, s) : a(e, t).fill(i) : a(e, t)
                }(null, e, t, i)
                ...
                if (e === t) return 0;
                for (var i = e.length, s = t.length, n = 0, r = Math.min(i, s); n < r; ++n) if (e[n] !== t[n]) {
                    i = e[n], s = t[n];
                    break
                }
            ...
            }, c.prototype.compare = function (e, t, i, s, n) {
                if (!c.isBuffer(e)) throw new TypeError("Argument must be a Buffer");
                ...
                if (t >= i) return 1;
                if (this === e) return 0;
                for (var r = (n >>>= 0) - (s >>>= 0), o = (i >>>= 0) - (t >>>= 0), a = Math.min(r, o), l = this.slice(s, n), h = e.slice(t, i), u = 0; u < a; ++u) if (l[u] !== h[u]) {
                    r = l[u], o = h[u];
                    break
                }
                ...
                if (void 0 === t) s = "utf8", i = this.length, t = 0; else if (void 0 === i && "string" == typeof t) s = t, i = this.length, t = 0; else {
            ...
            function D(e, t, i) {
                var s = "";
                i = Math.min(e.length, i);
                for (var n = t; n < i; ++n) s += String.fromCharCode(127 & e[n]);
                return s
            }
            ...
            function N(e, t, i) {
                var s = "";
                i = Math.min(e.length, i);
                for (var n = t; n < i; ++n) s += String.fromCharCode(e[n]);
                return s
            }
            ...
            function R(e, t, i) {
                ...
                for (var n = "", r = t; r < i; ++r) n += j(e[r]);
                return n
            }

            function C(e, t, i) {
                for (var s = e.slice(t, i), n = "", r = 0; r < s.length; r += 2) n += String.fromCharCode(s[r] + 256 * s[r + 1]);
                return n
            }
            ...
            function M(e, t, i, s) {
                t < 0 && (t = 65535 + t + 1);
                for (var n = 0, r = Math.min(e.length - i, 2); n < r; ++n) e[i + n] = (t & 255 << 8 * (s ? n : 1 - n)) >>> 8 * (s ? n : 1 - n)
            }

            function U(e, t, i, s) {
                t < 0 && (t = 4294967295 + t + 1);
                for (var n = 0, r = Math.min(e.length - i, 4); n < r; ++n) e[i + n] = t >>> 8 * (s ? n : 3 - n) & 255
            }

            function P(e, t, i, s, n, r) {
                if (i + s > e.length) throw new RangeError("Index out of range");
                if (i < 0) throw new RangeError("Index out of range")
            }

            function x(e, t, i, s, r) {
                return r || P(e, 0, i, 4), n.write(e, t, i, s, 23, 4), i + 4
            }

            function G(e, t, i, s, r) {
                return r || P(e, 0, i, 8), n.write(e, t, i, s, 52, 8), i + 8
            }

            c.prototype.slice = function (e, t) {
                var i, s = this.length;
                if ((e = ~~e) < 0 ? (e += s) < 0 && (e = 0) : e > s && (e = s), (t = void 0 === t ? s : ~~t) < 0 ? (t += s) < 0 && (t = 0) : t > s && (t = s), t < e && (t = e), c.TYPED_ARRAY_SUPPORT) (i = this.subarray(e, t)).__proto__ = c.prototype; else {
                    var n = t - e;
                    i = new c(n, void 0);
                ...
                return t || O(e, 4, this.length), n.read(this, e, !0, 23, 4)
            }, c.prototype.readFloatBE = function (e, t) {
                return t || O(e, 4, this.length), n.read(this, e, !1, 23, 4)
            }, c.prototype.readDoubleLE = function (e, t) {
                return t || O(e, 8, this.length), n.read(this, e, !0, 52, 8)
            }, c.prototype.readDoubleBE = function (e, t) {
                return t || O(e, 8, this.length), n.read(this, e, !1, 52, 8)
            }, c.prototype.writeUIntLE = function (e, t, i, s) {
                (e = +e, t |= 0, i |= 0, s) || L(this, e, t, i, Math.pow(2, 8 * i) - 1, 0);
                var n = 1, r = 0;
                for (this[t] = 255 & e; ++r < i && (n *= 256);) this[t + r] = e / n & 255;
                return t + i
            }, c.prototype.writeUIntBE = function (e, t, i, s) {
                (e = +e, t |= 0, i |= 0, s) || L(this, e, t, i, Math.pow(2, 8 * i) - 1, 0);
                var n = i - 1, r = 1;
                for (this[t + n] = 255 & e; --n >= 0 && (r *= 256);) this[t + n] = e / r & 255;
                return t + i
            }, c.prototype.writeUInt8 = function (e, t, i) {
                return e = +e, t |= 0, i || L(this, e, t, 1, 255, 0), c.TYPED_ARRAY_SUPPORT || (e = Math.floor(e)), this[t] = 255 & e, t + 1
            }, c.prototype.writeUInt16LE = function (e, t, i) {
                return e = +e, t |= 0, i || L(this, e, t, 2, 65535, 0), c.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8) : M(this, e, t, !0), t + 2
            }, c.prototype.writeUInt16BE = function (e, t, i) {
                return e = +e, t |= 0, i || L(this, e, t, 2, 65535, 0), c.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 8, this[t + 1] = 255 & e) : M(this, e, t, !1), t + 2
            }, c.prototype.writeUInt32LE = function (e, t, i) {
                return e = +e, t |= 0, i || L(this, e, t, 4, 4294967295, 0), c.TYPED_ARRAY_SUPPORT ? (this[t + 3] = e >>> 24, this[t + 2] = e >>> 16, this[t + 1] = e >>> 8, this[t] = 255 & e) : U(this, e, t, !0), t + 4
            }, c.prototype.writeUInt32BE = function (e, t, i) {
                return e = +e, t |= 0, i || L(this, e, t, 4, 4294967295, 0), c.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e) : U(this, e, t, !1), t + 4
                ...
                var r = 0, o = 1, a = 0;
                for (this[t] = 255 & e; ++r < i && (o *= 256);) e < 0 && 0 === a && 0 !== this[t + r - 1] && (a = 1), this[t + r] = (e / o >> 0) - a & 255;
                return t + i
                ...
                var r = i - 1, o = 1, a = 0;
                for (this[t + r] = 255 & e; --r >= 0 && (o *= 256);) e < 0 && 0 === a && 0 !== this[t + r + 1] && (a = 1), this[t + r] = (e / o >> 0) - a & 255;
                return t + i
            }, c.prototype.writeInt8 = function (e, t, i) {
                return e = +e, t |= 0, i || L(this, e, t, 1, 127, -128), c.TYPED_ARRAY_SUPPORT || (e = Math.floor(e)), e < 0 && (e = 255 + e + 1), this[t] = 255 & e, t + 1
            }, c.prototype.writeInt16LE = function (e, t, i) {
                return e = +e, t |= 0, i || L(this, e, t, 2, 32767, -32768), c.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8) : M(this, e, t, !0), t + 2
            }, c.prototype.writeInt16BE = function (e, t, i) {
                return e = +e, t |= 0, i || L(this, e, t, 2, 32767, -32768), c.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 8, this[t + 1] = 255 & e) : M(this, e, t, !1), t + 2
            }, c.prototype.writeInt32LE = function (e, t, i) {
                return e = +e, t |= 0, i || L(this, e, t, 4, 2147483647, -2147483648), c.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8, this[t + 2] = e >>> 16, this[t + 3] = e >>> 24) : U(this, e, t, !0), t + 4
            }, c.prototype.writeInt32BE = function (e, t, i) {
                return e = +e, t |= 0, i || L(this, e, t, 4, 2147483647, -2147483648), e < 0 && (e = 4294967295 + e + 1), c.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e) : U(this, e, t, !1), t + 4
                ...
                var n, r = s - i;
                if (this === e && i < t && t < s) for (n = r - 1; n >= 0; --n) e[n + t] = this[n + i]; else if (r < 1e3 || !c.TYPED_ARRAY_SUPPORT) for (n = 0; n < r; ++n) e[n + t] = this[n + i]; else Uint8Array.prototype.set.call(e, this.subarray(i, i + r), t);
                return r
            }, c.prototype.fill = function (e, t, i, s) {
                if ("string" == typeof e) {
                    if ("string" == typeof t ? (s = t, t = 0, i = this.length) : "string" == typeof i && (s = i, i = this.length), 1 === e.length) {
                        var n = e.charCodeAt(0);
                        n < 256 && (e = n)
                    }
                    if (void 0 !== s && "string" != typeof s) throw new TypeError("encoding must be a string");
                    if ("string" == typeof s && !c.isEncoding(s)) throw new TypeError("Unknown encoding: " + s)
                } else "number" == typeof e && (e &= 255);
                if (t < 0 || this.length < t || this.length < i) throw new RangeError("Out of range index");
                if (i <= t) return this;
                var r;
                if (t >>>= 0, i = void 0 === i ? this.length : i >>> 0, e || (e = 0), "number" == typeof e) for (r = t; r < i; ++r) this[r] = e; else {
                    var o = c.isBuffer(e) ? e : B(new c(e, s).toString()), a = o.length;
                    for (r = 0; r < i - t; ++r) this[r + t] = o[r % a]
                }
                return this
            };
            var k = /[^+\/0-9A-Za-z-_]/g;
            ...
            function B(e, t) {
                var i;
                t = t || 1 / 0;
                for (var s = e.length, n = null, r = [], o = 0; o < s; ++o) {
            ...
            function H(e, t, i, s) {
                for (var n = 0; n < s && !(n + i >= t.length || n >= e.length); ++n) t[n + i] = e[n];
                return n
            }
        }).call(this, i(22))
    }, function (e, t) {
        ...
        const s = {
            ...
            TextChannel: i(42),
            VoiceChannel: i(80),
            CategoryChannel: i(81),
            NewsChannel: i(82),
            StoreChannel: i(83),
            GuildMember: i(10),
            Guild: i(54),
            Message: i(29),
            MessageReaction: i(52),
            Presence: i(13).Presence,
            ClientPresence: i(91),
            VoiceState: i(28),
            Role: i(19),
            User: i(27)
        ...
        e.exports = class Structures {
            ...
            static extend(e, t) {
                if (!s[e]) throw new RangeError(`"${e}" is not a valid extensible structure.`);
                ...
                if ("function" != typeof i) {
                    throw new TypeError(`The extender function must return the extended structure class/prototype ${`(received ${typeof i})`}.`)
                }
                if (!(i.prototype instanceof s[e])) {
                    const t = Object.getPrototypeOf(i),
                        n = `${i.name || "unnamed"}${t.name ? " extends " + t.name : ""}`;
                    throw new Error(`The class/prototype returned from the extender function must extend the existing structure class/prototype (received function ${n}; expected extension of ${s[e].name}).`)
                }
                return s[e] = i, i
            }
        }
        ...
        "use strict";
        const s = i(41), {Error: n} = i(3), r = i(65), o = i(8);

        class GuildEmoji extends s {
            _clone() {
                const e = super._clone();
                return e._roles = this._roles.slice(), e
            }
            ...
            edit(e, t) {
                const i = e.roles ? e.roles.map(e => e.id || e) : void 0;
                return this.client.api.guilds(this.guild.id).emojis(this.id).patch({
                    data: {name: e.name, roles: i},
                    reason: t
                }).then(e => {
                    const t = this._clone();
                    return t._patch(e), t
        ...
        "use strict";
        const s = i(5), {Presence: n} = i(13), r = i(34), {Error: o} = i(3), a = i(7), c = i(79);
        ...
        class User extends s {
            ...
            _patch(e) {
                e.username && (this.username = e.username), e.discriminator && (this.discriminator = e.discriminator), void 0 !== e.avatar && (this.avatar = e.avatar), void 0 !== e.bot && (this.bot = Boolean(e.bot)), void 0 !== e.system && (this.system = Boolean(e.system)), e.locale && (this.locale = e.locale), void 0 !== e.public_flags && (this.flags = new c(e.public_flags)), this.lastMessageID = null, this.lastMessageChannelID = null
            }
            ...
            avatarURL({format: e, size: t, dynamic: i} = {}) {
                return this.avatar ? this.client.rest.cdn.Avatar(this.id, this.avatar, e, t, i) : null
            }
            ...
            async fetchFlags() {
                ...
                const e = await this.client.api.users(this.id).get();
                return this._patch(e), this.flags
            }
        ...
        "use strict";
        const s = i(5), {Error: n, TypeError: r} = i(3), {browser: o} = i(0);
        e.exports = class VoiceState extends s {
            constructor(e, t) {
                super(e.client), this.guild = e, this.id = t.user_id, this._patch(t)
            }

            _patch(e) {
                return this.serverDeaf = e.deaf, this.serverMute = e.mute, this.selfDeaf = e.self_deaf, this.selfMute = e.self_mute, this.selfVideo = e.self_video, this.sessionID = e.session_id, this.streaming = e.self_stream || !1, this.channelID = e.channel_id, this
            }
        ...
        e.exports = class Message extends n {
            ...
            _patch(e) {
                ...
                } : null, this._edits = [], this.member && e.member ? this.member._patch(e.member) : e.member && this.guild && this.author && this.guild.members.add(Object.assign(e.member, {user: this.author})), this.flags = new m(e.flags).freeze(), this.reference = e.message_reference ? {
            ...
            patch(e) {
                ...
                this.mentions = new c(this, "mentions" in e ? e.mentions : this.mentions.users, "mention_roles" in e ? e.mention_roles : this.mentions.roles, "mention_everyone" in e ? e.mention_everyone : this.mentions.everyone, "mention_channels" in e ? e.mention_channels : this.mentions.crosspostedChannels), this.flags = new m("flags" in e ? e.flags : 0).freeze()
            }
            ...
            get cleanContent() {
                return null != this.content ? E.cleanContent(this.content, this) : null
            }
            ...
            awaitReactions(e, t = {}) {
                return new Promise((i, s) => {
                    this.createReactionCollector(e, t).once("end", (e, n) => {
                        t.errors && t.errors.includes(n) ? s(e) : i(e)
                    })
                })
            }
            ...
            get deletable() {
                return !this.deleted && (this.author.id === this.client.user.id || this.guild && this.channel.permissionsFor(this.client.user).has(g.FLAGS.MANAGE_MESSAGES, !1))
            }

            get pinnable() {
                return "DEFAULT" === this.type && (!this.guild || this.channel.permissionsFor(this.client.user).has(g.FLAGS.MANAGE_MESSAGES, !1))
            }

            edit(e, t) {
                const {data: i} = e instanceof s ? e.resolveData() : s.create(this, e, t).resolveData();
                return this.client.api.channels[this.channel.id].messages[this.id].patch({data: i}).then(e => {
                    const t = this._clone();
                    return t._patch(e), t
                })
            }
            ...
            react(e) {
                ...
                return this.client.api.channels(this.channel.id).messages(this.id).reactions(e, "@me").put().then(() => this.client.actions.MessageReactionAdd.handle({
                    ...
                    message: this,
                    emoji: E.parseEmoji(e)
                }).reaction)
            }

            delete(e = {}) {
                if ("object" != typeof e) throw new u("INVALID_TYPE", "options", "object", !0);
                const {timeout: t = 0, reason: i} = e;
                return t <= 0 ? this.channel.messages.delete(this.id, i).then(() => this) : new Promise(e => {
                    this.client.setTimeout(() => {
                        e(this.delete({reason: i}))
                    }, t)
                })
            }

            reply(e, t) {
                return this.channel.send(e instanceof s ? e : s.transformOptions(e, t, {reply: this.member || this.author}))
            }
            ...
            suppressEmbeds(e = !0) {
                const t = new m(this.flags.bitfield);
                return e ? t.add(m.FLAGS.SUPPRESS_EMBEDS) : t.remove(m.FLAGS.SUPPRESS_EMBEDS), this.edit({flags: t})
            }

            equals(e, t) {
                if (!e) return !1;
                if (!e.author && !e.attachments) return this.id === e.id && this.embeds.length === e.embeds.length;
                let i = this.id === e.id && this.author.id === e.author.id && this.content === e.content && this.tts === e.tts && this.nonce === e.nonce && this.embeds.length === e.embeds.length && this.attachments.length === e.attachments.length;
                return i && t && (i = this.mentions.everyone === e.mentions.everyone && this.createdTimestamp === new Date(t.timestamp).getTime() && this.editedTimestamp === new Date(t.edited_timestamp).getTime()), i
            }
        ...
        "use strict";
        const s = i(5), n = i(7);
        e.exports = class Emoji extends s {
            constructor(e, t) {
        ...
        "use strict";
        (function (t) {
            const s = i(44), n = i(45), {RangeError: r} = i(3), {browser: o} = i(0), a = i(9), c = i(48), l = i(4);
            ...
            class APIMessage {
                ...
                makeContent() {
                    const e = i(10);
                    let t;
                    if (null === this.options.content ? t = "" : void 0 !== this.options.content && (t = l.resolveString(this.options.content)), "string" != typeof t) return t;
                    const s = void 0 === this.options.disableMentions ? this.target.client.options.disableMentions : this.options.disableMentions;
                    "all" === s ? t = l.removeMentions(t) : "everyone" === s && (t = t.replace(/@([^<>@ ]*)/gmus, (e, t) => t.match(/^[&!]?\d+$/) ? "@" + t : "@​" + t));
                ...
                resolveData() {
                    ...
                    let i;
                    if (void 0 !== this.options.nonce && (i = parseInt(this.options.nonce), isNaN(i) || i < 0)) throw new r("MESSAGE_NONCE_TYPE");
                    const s = [];
                    this.isWebhook ? this.options.embeds && s.push(...this.options.embeds) : this.options.embed && s.push(this.options.embed);
                    const o = s.map(e => new n(e).toJSON());
                    let a, l, h;
                    this.isWebhook && (a = this.options.username || this.target.name, this.options.avatarURL && (l = this.options.avatarURL)), this.isMessage && (h = null != this.options.flags ? new c(this.options.flags).bitfield : this.target.flags.bitfield);
                    const u = void 0 === this.options.allowedMentions ? this.target.client.options.allowedMentions : this.options.allowedMentions;
                    return this.data = {
                        content: e,
                        tts: t,
                        nonce: i,
                        ...
                        username: a,
                        avatar_url: l,
                        allowed_mentions: "string" == typeof e ? u : void 0,
                        flags: h
                    }, this
                }
                ...
                async resolveFiles() {
                    ...
                    for (const i of e) i.files && t.push(...i.files);
                ...
                split() {
                    ...
                    for (let t = 0; t < this.data.content.length; t++) {
                        let i, s;
                        t === this.data.content.length - 1 ? (i = {
                            ...this.data,
                            content: this.data.content[t]
                        }, s = {...this.options, content: this.data.content[t]}) : (i = {
                            content: this.data.content[t],
                            tts: this.data.tts
                        }, s = {content: this.data.content[t], tts: this.data.tts});
                        const n = new APIMessage(this.target, s);
                        n.data = i, e.push(n)
                    }
                    return e
                }
                ...
                static async resolveFile(e) {
                    let i, s;
                    const n = e => "string" == typeof e ? l.basename(e) : e.path ? l.basename(e.path) : "file.jpg";
                    "string" == typeof e || e instanceof (o ? ArrayBuffer : t) || "function" == typeof e.pipe ? (i = e, s = n(i)) : (i = e.attachment, s = e.name || n(i));
                    return {attachment: i, name: s, file: await a.resolveFile(i)}
                }

                static partitionMessageAdditions(e) {
                    const t = [], i = [];
                    for (const r of e) r instanceof n ? t.push(r) : r instanceof s && i.push(r);
                    return [t, i]
                }

                static transformOptions(e, t, i = {}, r = !1) {
                    if (t || "object" != typeof e || Array.isArray(e) || (t = e, e = void 0), t) {
                        if (t instanceof n) return r ? {content: e, embeds: [t], ...i} : {content: e, embed: t, ...i};
                        if (t instanceof s) return {content: e, files: [t], ...i}
                    } else t = {};
                    if (Array.isArray(t)) {
                        const [s, n] = this.partitionMessageAdditions(t);
                        return r ? {content: e, embeds: s, files: n, ...i} : {content: e, embed: s[0], files: n, ...i}
                    }
                    if (Array.isArray(e)) {
                        const [t, s] = this.partitionMessageAdditions(e);
                        if (t.length || s.length) return r ? {embeds: t, files: s, ...i} : {embed: t[0], files: s, ...i}
                    }
                    return {content: e, ...t, ...i}
                }

                static create(e, t, s, n = {}) {
                    const r = i(12), o = i(49), a = e instanceof r || e instanceof o;
                    return new this(e, this.transformOptions(t, s, n, a))
                }
            }
        ...
        n.from && n.alloc && n.allocUnsafe && n.allocUnsafeSlow ? e.exports = s : (r(s, t), t.Buffer = o), r(n, o), o.from = function (e, t, i) {
            if ("number" == typeof e) throw new TypeError("Argument must not be a number");
            return n(e, t, i)
        }, o.alloc = function (e, t, i) {
            if ("number" != typeof e) throw new TypeError("Argument must be a number");
            var s = n(e);
            return void 0 !== t ? "string" == typeof i ? s.fill(t, i) : s.fill(t) : s.fill(0), s
        ...
        "use strict";
        const s = i(72), n = i(31), r = i(7), o = i(2), {RangeError: a, TypeError: c} = i(3);
        ...
        class TextBasedChannel {
            ...
            async send(e, t) {
                const s = i(27), r = i(10);
                if (this instanceof s || this instanceof r) return this.createDM().then(i => i.send(e, t));
                let o;
                ...
                return t.promise = new Promise((i, s) => {
                    ...
                    Object.assign(t, {
                        count: e || 1, interval: this.client.setInterval(() => {
                            n.post().catch(e => {
                                this.client.clearInterval(t.interval), this.client.user._typing.delete(this.id), s(e)
                            })
                        }, 9e3), resolve: i
                    }), n.post().catch(e => {
                        this.client.clearInterval(t.interval), this.client.user._typing.delete(this.id), s(e)
            ...
            async bulkDelete(e, t = !1) {
                if (Array.isArray(e) || e instanceof o) {
                    let i = e instanceof o ? e.keyArray() : e.map(e => e.id || e);
                    if (t && (i = i.filter(e => Date.now() - r.deconstruct(e).date.getTime() < 12096e5)), 0 === i.length) return new o;
                    if (1 === i.length) {
                        await this.client.api.channels(this.id).messages(i[0]).delete();
                        const e = this.client.actions.MessageDelete.getMessage({message_id: i[0]}, this);
                        return e ? new o([[e.id, e]]) : new o
                    }
                    return await this.client.api.channels[this.id].messages["bulk-delete"].post({data: {messages: i}}), i.reduce((e, t) => e.set(t, this.client.actions.MessageDeleteBulk.getMessage({message_id: t}, this)), new o)
                }
                if (!isNaN(e)) {
            ...
            static applyToClass(e, t = !1, i = []) {
                const s = ["send"];
                t && s.push("lastMessage", "lastPinAt", "bulkDelete", "startTyping", "stopTyping", "typing", "typingCount", "createMessageCollector", "awaitMessages");
                for (const t of s) i.includes(t) || Object.defineProperty(e.prototype, t, Object.getOwnPropertyDescriptor(TextBasedChannel.prototype, t))
            }
        }
        ...
        "use strict";
        const s = i(6), n = i(29), r = i(2), o = i(134);
        e.exports = class MessageManager extends s {
            constructor(e, t) {
            ...
            fetchPinned(e = !0) {
                return this.client.api.channels[this.channel.id].pins.get().then(t => {
                    const i = new r;
                    for (const s of t) i.set(s.id, this.add(s, e));
                    return i
                })
            }
            ...
            async _fetchId(e, t) {
                ...
                if (i && !i.partial) return i;
                const s = await this.client.api.channels[this.channel.id].messages[e].get();
                return this.add(s, t)
            }

            async _fetchMany(e = {}, t) {
                const i = await this.client.api.channels[this.channel.id].messages.get({query: e}), s = new r;
                for (const e of i) s.set(e.id, this.add(e, t));
                return s
            }
        }
    }, function (e, t) {
        ...
        (function (t, s) {
            i(62);
            const n = i(15), r = i(104), {DefaultOptions: o} = i(0), a = i(4);
            e.exports = class BaseClient extends n {
                ...
                setTimeout(e, t, ...i) {
                    const s = setTimeout(() => {
                        e(...i), this._timeouts.delete(s)
                    }, t);
                    return this._timeouts.add(s), s
                }
                ...
                setInterval(e, t, ...i) {
                    const s = setInterval(e, t, ...i);
                    return this._intervals.add(s), s
                }
                ...
                setImmediate(e, ...i) {
                    const s = t(e, ...i);
                    return this._immediates.add(s), s
                }

                clearImmediate(e) {
                    s(e), this._immediates.delete(e)
                }

                incrementMaxListeners() {
                    const e = this.getMaxListeners();
                    0 !== e && this.setMaxListeners(e + 1)
                }
        ...
        }).call(this, i(39).setImmediate, i(39).clearImmediate)
    }, function (e, t, i) {
        (function (e) {
            var s = void 0 !== e && e || "undefined" != typeof self && self || window, n = Function.prototype.apply;
            ...
            }, i(62), t.setImmediate = "undefined" != typeof self && self.setImmediate || void 0 !== e && e.setImmediate || this && this.setImmediate, t.clearImmediate = "undefined" != typeof self && self.clearImmediate || void 0 !== e && e.clearImmediate || this && this.clearImmediate
        }).call(this, i(22))
    }, function (e, t, i) {
        "use strict";
        const s = i(16), n = i(34), r = i(35);

        class DMChannel extends s {
            constructor(e, t) {
        ...
        "use strict";
        const s = i(30);
        e.exports = class BaseGuildEmoji extends s {
            constructor(e, t, i) {
                super(e, t), this.guild = i, Object.defineProperty(this, "_roles", {
                    value: [],
                    writable: !0
                }), this._patch(t)
            }
        ...
        "use strict";
        const s = i(17), n = i(12), r = i(34), o = i(35), a = i(2), c = i(9);
        ...
        class TextChannel extends s {
            ...
            fetchWebhooks() {
                return this.client.api.channels[this.id].webhooks.get().then(e => {
                    const t = new a;
                    for (const i of e) t.set(i.id, new n(this.client, i));
                    return t
                })
            }

            async createWebhook(e, {avatar: t, reason: i} = {}) {
        ...
        "use strict";
        const s = i(19), {TypeError: n} = i(3), r = i(8), o = i(4);
        e.exports = class PermissionOverwrites {
            ...
            update(e, t) {
                const {allow: i, deny: s} = this.constructor.resolveOverwriteOptions(e, this);
            ...
            static resolveOverwriteOptions(e, {allow: t, deny: i} = {}) {
                t = new r(t), i = new r(i);
                for (const [s, n] of Object.entries(e)) !0 === n ? (t.add(r.FLAGS[s]), i.remove(r.FLAGS[s])) : !1 === n ? (t.remove(r.FLAGS[s]), i.add(r.FLAGS[s])) : null === n && (t.remove(r.FLAGS[s]), i.remove(r.FLAGS[s]));
            ...
            static resolve(e, t) {
                ...
                if (!i) throw new n("INVALID_TYPE", "parameter", "User nor a Role");
                const o = i instanceof s ? "role" : "member";
                return {id: i.id, type: o, allow: r.resolve(e.allow), deny: r.resolve(e.deny)}
            }
        }
    }, function (e, t, i) {
        "use strict";
        ...
        e.exports = class MessageAttachment {
            constructor(e, t = null, i) {
                this.attachment = e, this.name = t, i && this._patch(i)
            }
            ...
            get spoiler() {
                return s.basename(this.url).startsWith("SPOILER_")
            }

            toJSON() {
                return s.flatten(this)
            }
        }
    }, function (e, t, i) {
        "use strict";
        const {RangeError: s} = i(3), n = i(4);
        e.exports = class MessageEmbed {
            ...
            addField(e, t, i) {
                return this.addFields({name: e, value: t, inline: i})
            }
            ...
            spliceFields(e, t, ...i) {
                return this.fields.splice(e, t, ...this.constructor.normalizeFields(...i)), this
            }
            ...
            setAuthor(e, t, i) {
                return this.author = {name: n.resolveString(e), iconURL: t, url: i}, this
            }
            ...
            setFooter(e, t) {
                return e = n.resolveString(e), this.footer = {text: e, iconURL: t, proxyIconURL: void 0}, this
            }
            ...
            static normalizeField(e, t, i = !1) {
                if (!(e = n.resolveString(e))) throw new s("EMBED_FIELD_NAME");
                if (!(t = n.resolveString(t))) throw new s("EMBED_FIELD_VALUE");
                return {name: e, value: t, inline: i}
            }
        ...
        (t = e.exports = i(66)).Stream = t, t.Readable = t, t.Writable = i(47), t.Duplex = i(20), t.Transform = i(70), t.PassThrough = i(128)
    }, function (e, t, i) {
        "use strict";
        (function (t, s, n) {
            var r = i(32);
            ...
            e.exports = _;
            var a, c = !t.browser && ["v0.10", "v0.9."].indexOf(t.version.slice(0, 5)) > -1 ? s : r.nextTick;
            _.WritableState = E;
            var l = Object.create(i(26));
            l.inherits = i(23);
            var h = {deprecate: i(127)}, u = i(67), d = i(33).Buffer, p = n.Uint8Array || function () {
            };
            var f, m = i(68);
            ...
            function E(e, t) {
                ...
                var n = e.highWaterMark, l = e.writableHighWaterMark, h = this.objectMode ? 16 : 16384;
                this.highWaterMark = n || 0 === n ? n : s && (l || 0 === l) ? l : h, this.highWaterMark = Math.floor(this.highWaterMark), this.finalCalled = !1, this.needDrain = !1, this.ending = !1, this.ended = !1, this.finished = !1, this.destroyed = !1;
                ...
                this.decodeStrings = !u, this.defaultEncoding = e.defaultEncoding || "utf8", this.length = 0, this.writing = !1, this.corked = 0, this.sync = !0, this.bufferProcessing = !1, this.onwrite = function (e) {
                    !function (e, t) {
                        var i = e._writableState, s = i.sync, n = i.writecb;
                        if (function (e) {
                            e.writing = !1, e.writecb = null, e.length -= e.writelen, e.writelen = 0
                        }(i), t) !function (e, t, i, s, n) {
                            --t.pendingcb, i ? (r.nextTick(n, s), r.nextTick(S, e, t), e._writableState.errorEmitted = !0, e.emit("error", s)) : (n(s), e._writableState.errorEmitted = !0, e.emit("error", s), S(e, t))
                        }(e, i, s, t, n); else {
                            var o = w(i);
                            o || i.corked || i.bufferProcessing || !i.bufferedRequest || b(e, i), s ? c(v, e, i, o, n) : v(e, i, o, n)
                        }
                    }(t, e)
            ...
            function _(e) {
                if (a = a || i(20), !(f.call(_, this) || this instanceof a)) return new _(e);
                this._writableState = new E(e, this), this.writable = !0, e && ("function" == typeof e.write && (this._write = e.write), "function" == typeof e.writev && (this._writev = e.writev), "function" == typeof e.destroy && (this._destroy = e.destroy), "function" == typeof e.final && (this._final = e.final)), u.call(this)
            }

            function y(e, t, i, s, n, r, o) {
                t.writelen = s, t.writecb = o, t.writing = !0, t.sync = !0, i ? e._writev(n, t.onwrite) : e._write(n, r, t.onwrite), t.sync = !1
            }

            function v(e, t, i, s) {
                i || function (e, t) {
                    0 === t.length && t.needDrain && (t.needDrain = !1, e.emit("drain"))
                }(e, t), t.pendingcb--, s(), S(e, t)
            }
            ...
            function b(e, t) {
                ...
                if (e._writev && i && i.next) {
                    var s = t.bufferedRequestCount, n = new Array(s), r = t.corkedRequestsFree;
                    r.entry = i;
                    for (var a = 0, c = !0; i;) n[a] = i, i.isBuf || (c = !1), i = i.next, a += 1;
                    n.allBuffers = c, y(e, t, !0, t.length, n, "", r.finish), t.pendingcb++, t.lastBufferedRequest = null, r.next ? (t.corkedRequestsFree = r.next, r.next = null) : t.corkedRequestsFree = new o(t), t.bufferedRequestCount = 0
                } else {
                    for (; i;) {
                        var l = i.chunk, h = i.encoding, u = i.callback;
                        if (y(e, t, !1, t.objectMode ? 1 : l.length, l, h, u), i = i.next, t.bufferedRequestCount--, t.writing) break
                    }
            ...
            function A(e, t) {
                e._final((function (i) {
                    t.pendingcb--, i && e.emit("error", i), t.prefinished = !0, e.emit("prefinish"), S(e, t)
                }))
            }
            ...
            function S(e, t) {
                ...
                return i && (!function (e, t) {
                    t.prefinished || t.finalCalled || ("function" == typeof e._final ? (t.pendingcb++, t.finalCalled = !0, r.nextTick(A, e, t)) : (t.prefinished = !0, e.emit("prefinish")))
                }(e, t), 0 === t.pendingcb && (t.finished = !0, e.emit("finish"))), i
            }

            l.inherits(_, u), E.prototype.getBuffer = function () {
            ...
            }(), "function" == typeof Symbol && Symbol.hasInstance && "function" == typeof Function.prototype[Symbol.hasInstance] ? (f = Function.prototype[Symbol.hasInstance], Object.defineProperty(_, Symbol.hasInstance, {
                value: function (e) {
                    return !!f.call(this, e) || this === _ && (e && e._writableState instanceof E)
                }
            })) : f = function (e) {
                ...
                var s, n = this._writableState, o = !1, a = !n.objectMode && (s = e, d.isBuffer(s) || s instanceof p);
                ...
                }(this, i) : (a || function (e, t, i, s) {
                    var n = !0, o = !1;
                    return null === i ? o = new TypeError("May not write null values to stream") : "string" == typeof i || void 0 === i || t.objectMode || (o = new TypeError("Invalid non-string/buffer chunk")), o && (e.emit("error", o), r.nextTick(s, o), n = !1), n
                }(this, n, e, i)) && (n.pendingcb++, o = function (e, t, i, s, n, r) {
                    if (!i) {
                        var o = function (e, t, i) {
                            e.objectMode || !1 === e.decodeStrings || "string" != typeof t || (t = d.from(t, i));
                            return t
                        }(t, s, n);
                        s !== o && (i = !0, n = "buffer", s = o)
                    }
            ...
            }, _.prototype._writev = null, _.prototype.end = function (e, t, i) {
                var s = this._writableState;
                "function" == typeof e ? (i = e, e = null, t = null) : "function" == typeof t && (i = t, t = null), null != e && this.write(e, t), s.corked && (s.corked = 1, this.uncork()), s.ending || s.finished || function (e, t, i) {
                    t.ending = !0, S(e, t), i && (t.finished ? r.nextTick(i) : e.once("finish", i));
        ...
        }).call(this, i(14), i(39).setImmediate, i(22))
    }, function (e, t, i) {
        "use strict";
        const s = i(11);

        class MessageFlags extends s {
        }
        ...
        class WebhookClient extends s {
            constructor(e, t, i) {
                super(i), Object.defineProperty(this, "client", {value: this}), this.id = e, Object.defineProperty(this, "token", {
                    value: t,
                    writable: !0,
                    configurable: !0
                })
        ...
        n.applyToClass(WebhookClient), e.exports = WebhookClient
    }, function (e, t, i) {
        "use strict";
        const s = i(15), n = i(2), r = i(4);

        class Collector extends s {
            constructor(e, t, i = {}) {
                super(), Object.defineProperty(this, "client", {value: e}), this.filter = t, this.options = i, this.collected = new n, this.ended = !1, this._timeout = null, this._idletimeout = null, this.handleCollect = this.handleCollect.bind(this), this.handleDispose = this.handleDispose.bind(this), i.time && (this._timeout = this.client.setTimeout(() => this.stop("time"), i.time)), i.idle && (this._idletimeout = this.client.setTimeout(() => this.stop("idle"), i.idle))
            }
            ...
            get next() {
                return new Promise((e, t) => {
                    ...
                    const i = () => {
                        this.removeListener("collect", s), this.removeListener("end", n)
                    }, s = t => {
                        i(), e(t)
                    }, n = () => {
                        i(), t(this.collected)
                    };
                    this.on("collect", s), this.on("end", n)
                })
            }
        ...
        "use strict";
        const s = i(5), n = i(74), {ClientApplicationAssetTypes: r, Endpoints: o} = i(0), a = i(7), c = Object.keys(r);
        e.exports = class ClientApplication extends s {
            constructor(e, t) {
                super(e), this._patch(t)
            }
        ...
        "use strict";
        const s = i(25), n = i(53), r = i(78), o = i(4);
        e.exports = class MessageReaction {
            constructor(e, t, i) {
                Object.defineProperty(this, "client", {value: e}), this.message = i, this.me = t.me, this.users = new r(e, void 0, this), this._emoji = new n(this, t.emoji), this._patch(t)
            }
            ...
            get emoji() {
                if (this._emoji instanceof s) return this._emoji;
                if (this._emoji.id) {
        ...
        "use strict";
        const s = i(30), n = i(4);
        e.exports = class ReactionEmoji extends s {
            constructor(e, t) {
        ...
        "use strict";
        const {deprecate: s} = i(84), n = i(5), r = i(85), o = i(56), a = i(55), c = i(18), l = i(57),
            h = i(12), {Error: u, TypeError: d} = i(3), p = i(86), f = i(58), m = i(87), g = i(88), E = i(89),
            _ = i(138),
            y = i(2), {ChannelTypes: v, DefaultMessageNotifications: b, PartialTypes: w, VerificationLevels: A, ExplicitContentFilterLevels: S} = i(0),
            I = i(9), T = i(7), D = i(90), N = i(4);

        class Guild extends n {
            constructor(e, t) {
                super(e), this.members = new m(this), this.channels = new p(this), this.roles = new E(this), this.presences = new g(this.client), this.voiceStates = new _(this), this.deleted = !1, t && (t.unavailable ? (this.available = !1, this.id = t.id) : (this._patch(t), t.channels || (this.available = !1)), this.shardID = t.shardID)
            }
            ...
            _patch(e) {
                ...
                if (this.emojis) e.emojis && this.client.actions.GuildEmojisUpdate.handle({
                    guild_id: this.id,
                    emojis: e.emojis
                }); else if (this.emojis = new f(this), e.emojis) for (const t of e.emojis) this.emojis.add(t)
            }
            ...
            get createdTimestamp() {
                return T.deconstruct(this.id).timestamp
            }
            ...
            iconURL({format: e, size: t, dynamic: i} = {}) {
                return this.icon ? this.client.rest.cdn.Icon(this.id, this.icon, e, t, i) : null
            }
            ...
            get owner() {
                return this.members.cache.get(this.ownerID) || (this.client.options.partials.includes(w.GUILD_MEMBER) ? this.members.add({user: {id: this.ownerID}}, !0) : null)
            }
            ...
            get me() {
                return this.members.cache.get(this.client.user.id) || (this.client.options.partials.includes(w.GUILD_MEMBER) ? this.members.add({user: {id: this.client.user.id}}, !0) : null)
            }
            ...
            fetch() {
                return this.client.api.guilds(this.id).get({query: {with_counts: !0}}).then(e => (this._patch(e), this))
            }

            fetchBan(e) {
                const t = this.client.users.resolveID(e);
                if (!t) throw new u("FETCH_BAN_RESOLVE_ID");
            ...
            fetchIntegrations() {
                return this.client.api.guilds(this.id).integrations.get().then(e => e.reduce((e, t) => e.set(t.id, new a(this.client, t, this)), new y))
            }
            ...
            fetchPreview() {
                return this.client.api.guilds(this.id).preview.get().then(e => new o(this.client, e))
            }

            fetchVanityCode() {
                return this.fetchVanityData().then(e => e.code)
            }

            async fetchVanityData() {
                if (!this.features.includes("VANITY_URL")) throw new u("VANITY_URL");
                const e = await this.client.api.guilds(this.id, "vanity-url").get();
                return this.vanityURLUses = e.uses, e
            }

            fetchWebhooks() {
                return this.client.api.guilds(this.id).webhooks.get().then(e => {
                    const t = new y;
                    for (const i of e) t.set(i.id, new h(this.client, i));
                    return t
                })
            }
            ...
            fetchVoiceRegions() {
                return this.client.api.guilds(this.id).regions.get().then(e => {
                    const t = new y;
                    for (const i of e) t.set(i.id, new l(i));
                    return t
                })
            }
            ...
            fetchAuditLogs(e = {}) {
                return e.before && e.before instanceof r.Entry && (e.before = e.before.id), "string" == typeof e.type && (e.type = r.Actions[e.type]), this.client.api.guilds(this.id)["audit-logs"].get({
                    query: {
                        before: e.before,
                        limit: e.limit,
                ...
                }).then(e => r.build(this, e))
            }

            addMember(e, t) {
                if (!(e = this.client.users.resolveID(e))) return Promise.reject(new d("INVALID_TYPE", "user", "UserResolvable"));
                if (this.members.cache.has(e)) return Promise.resolve(this.members.cache.get(e));
                if (t.access_token = t.accessToken, t.roles) {
                    const e = [];
                    for (let i of t.roles instanceof y ? t.roles.values() : t.roles) {
                        if (i = this.roles.resolve(i), !i) return Promise.reject(new d("INVALID_TYPE", "options.roles", "Array or Collection of Roles or Snowflakes", !0));
                        e.push(i.id)
                    }
                    t.roles = e
                }
            ...
            async setIcon(e, t) {
                return this.edit({icon: await I.resolveImage(e), reason: t})
            }
            ...
            async setSplash(e, t) {
                return this.edit({splash: await I.resolveImage(e), reason: t})
            }

            async setBanner(e, t) {
                return this.edit({banner: await I.resolveImage(e), reason: t})
            }
            ...
            leave() {
                return this.ownerID === this.client.user.id ? Promise.reject(new u("GUILD_OWNED")) : this.client.api.users("@me").guilds(this.id).delete().then(() => this.client.actions.GuildDelete.handle({id: this.id}).guild)
            }
            ...
            _sortedRoles() {
                return N.discordSort(this.roles.cache)
            }

            _sortedChannels(e) {
                const t = e.type === v.CATEGORY;
                return N.discordSort(this.channels.cache.filter(i => (["text", "news", "store"].includes(e.type) ? ["text", "news", "store"].includes(i.type) : i.type === e.type) && (t || i.parent === e.parent)))
            }
        }

        Guild.prototype.fetchVanityCode = s(Guild.prototype.fetchVanityCode, "Guild#fetchVanityCode: Use fetchVanityData() instead"), e.exports = Guild
    }, function (e, t, i) {
        "use strict";
        const s = i(5);
        e.exports = class Integration extends s {
            constructor(e, t, i) {
                super(e), this.guild = i, this.id = t.id, this.name = t.name, this.type = t.type, this.enabled = t.enabled, this.syncing = t.syncing, this.role = this.guild.roles.cache.get(t.role_id), this.user = this.client.users.add(t.user), this.account = t.account, this.syncedAt = t.synced_at, this._patch(t)
            }
        ...
        "use strict";
        const s = i(5), n = i(137), r = i(2);
        e.exports = class GuildPreview extends s {
            constructor(e, t) {
        ...
        "use strict";
        const s = i(6), {TypeError: n} = i(3), r = i(25), o = i(53), a = i(2), c = i(9);
        e.exports = class GuildEmojiManager extends s {
            constructor(e, t) {
        ...
        e.exports = {version: "12.2.0", homepage: "https://github.com/discordjs/discord.js#readme"}
    }, function (e, t, i) {
        "use strict";
        const s = Symbol("code"), n = new Map;
            ...
            return class DiscordjsError extends e {
                constructor(e, ...t) {
                    super(function (e, t) {
                        ...
                        return "function" == typeof i ? i(...t) : void 0 === t || 0 === t.length ? i : (t.unshift(i), String(...t))
                    }(e, t)), this[s] = e, Error.captureStackTrace && Error.captureStackTrace(this, DiscordjsError)
                }
        ...
        (function (e, t) {
            !function (e, i) {
                "use strict";
                if (!e.setImmediate) {
                    var s, n, r, o, a, c = 1, l = {}, h = !1, u = e.document,
                    ...
                    }, e.addEventListener ? e.addEventListener("message", a, !1) : e.attachEvent("onmessage", a), s = function (t) {
                        e.postMessage(o + t, "*")
        ...
        class DiscordAPIError extends Error {
            constructor(e, t, i, s) {
                ...
                this.name = "DiscordAPIError", this.message = t.message && n ? `${t.message}\n${n}` : t.message || n, this.method = i, this.path = e, this.code = t.code, this.httpStatus = s
            }
            ...
            static flattenErrors(e, t = "") {
                ...
                for (const [s, n] of Object.entries(e)) {
                    ...
                    const e = t ? isNaN(s) ? `${t}.${s}` : `${t}[${s}]` : s;
                    n._errors ? i.push(`${e}: ${n._errors.map(e => e.message).join(" ")}`) : n.code || n.message ? i.push(`${n.code ? n.code + ": " : ""}${n.message}`.trim()) : "string" == typeof n ? i.push(n) : i = i.concat(this.flattenErrors(n, e))
                }
                return i
            }
        }
        ...
        class HTTPError extends Error {
            constructor(e, t, i, s, n) {
                super(e), this.name = t, this.code = i || 500, this.method = s, this.path = n
            }
        }
        ...
        e.exports = class GuildEmojiRoleManager {
            ...
            add(e) {
                ...
                if ((e = e.map(e => this.guild.roles.resolve(e))).includes(null)) return Promise.reject(new s("INVALID_TYPE", "roles", "Array or Collection of Roles or Snowflakes", !0));
            ...
            remove(e) {
                ...
                if ((e = e.map(e => this.guild.roles.resolveID(e))).includes(null)) return Promise.reject(new s("INVALID_TYPE", "roles", "Array or Collection of Roles or Snowflakes", !0));
        ...
        (function (t, s) {
            ...
            }, c = i(67), l = i(33).Buffer, h = t.Uint8Array || function () {
            };
            var u = Object.create(i(26));
            u.inherits = i(23);
            var d = i(124), p = void 0;
            p = d && d.debuglog ? d.debuglog("stream") : function () {
            };
            var f, m = i(125), g = i(68);
            u.inherits(y, c);
            var E = ["error", "close", "destroy", "pause", "resume"];

            function _(e, t) {
                e = e || {};
                var s = t instanceof (r = r || i(20));
                this.objectMode = !!e.objectMode, s && (this.objectMode = this.objectMode || !!e.readableObjectMode);
                var n = e.highWaterMark, o = e.readableHighWaterMark, a = this.objectMode ? 16 : 16384;
                this.highWaterMark = n || 0 === n ? n : s && (o || 0 === o) ? o : a, this.highWaterMark = Math.floor(this.highWaterMark), this.buffer = new m, this.length = 0, this.pipes = null, this.pipesCount = 0, this.flowing = null, this.ended = !1, this.endEmitted = !1, this.reading = !1, this.sync = !0, this.needReadable = !1, this.emittedReadable = !1, this.readableListening = !1, this.resumeScheduled = !1, this.destroyed = !1, this.defaultEncoding = e.defaultEncoding || "utf8", this.awaitDrain = 0, this.readingMore = !1, this.decoder = null, this.encoding = null, e.encoding && (f || (f = i(69).StringDecoder), this.decoder = new f(e.encoding), this.encoding = e.encoding)
            }

            function y(e) {
                if (r = r || i(20), !(this instanceof y)) return new y(e);
            ...
            function v(e, t, i, s, n) {
                ...
                null === t ? (o.reading = !1, function (e, t) {
                    ...
                    var i;
                    s = t, l.isBuffer(s) || s instanceof h || "string" == typeof t || void 0 === t || e.objectMode || (i = new TypeError("Invalid non-string/buffer chunk"));
                    var s;
                    return i
                }(o, t)), r ? e.emit("error", r) : o.objectMode || t && t.length > 0 ? ("string" == typeof t || o.objectMode || Object.getPrototypeOf(t) === l.prototype || (t = function (e) {
                    return l.from(e)
                }(t)), s ? o.endEmitted ? e.emit("error", new Error("stream.unshift() after end event")) : b(e, o, t, !0) : o.ended ? e.emit("error", new Error("stream.push() after EOF")) : (o.reading = !1, o.decoder && !i ? (t = o.decoder.write(t), o.objectMode || 0 !== t.length ? b(e, o, t, !1) : I(e, o)) : b(e, o, t, !1))) : s || (o.reading = !1));
                return function (e) {
            ...
            function b(e, t, i, s) {
                t.flowing && 0 === t.length && !t.sync ? (e.emit("data", i), e.read(0)) : (t.length += t.objectMode ? 1 : i.length, s ? t.buffer.unshift(i) : t.buffer.push(i), t.needReadable && A(e)), I(e, t)
            }
            ...
            Object.defineProperty(y.prototype, "destroyed", {
                ...
                var i, s = this._readableState;
                return s.objectMode ? i = !0 : "string" == typeof e && ((t = t || s.defaultEncoding) !== s.encoding && (e = l.from(e, t), t = ""), i = !0), v(this, e, t, !1, i)
                ...
                return f || (f = i(69).StringDecoder), this._readableState.decoder = new f(e), this._readableState.encoding = e, this
            };
            ...
            function A(e) {
                ...
                t.needReadable = !1, t.emittedReadable || (p("emitReadable", t.flowing), t.emittedReadable = !0, t.sync ? n.nextTick(S, e) : S(e))
            }
            ...
            function N(e, t) {
                t.reading || (p("resume read 0"), e.read(0)), t.resumeScheduled = !1, t.awaitDrain = 0, e.emit("resume"), R(e), t.flowing && !t.reading && e.read(0)
            }
            ...
            function C(e, t) {
                return 0 === t.length ? null : (t.objectMode ? i = t.buffer.shift() : !e || e >= t.length ? (i = t.decoder ? t.buffer.join("") : 1 === t.buffer.length ? t.buffer.head.data : t.buffer.concat(t.length), t.buffer.clear()) : i = function (e, t, i) {
                    var s;
                    e < t.head.data.length ? (s = t.head.data.slice(0, e), t.head.data = t.head.data.slice(e)) : s = e === t.head.data.length ? t.shift() : i ? function (e, t) {
                        var i = t.head, s = 1, n = i.data;
                        e -= n.length;
                        for (; i = i.next;) {
                            var r = i.data, o = e > r.length ? r.length : e;
                            if (o === r.length ? n += r : n += r.slice(0, e), 0 === (e -= o)) {
                                o === r.length ? (++s, i.next ? t.head = i.next : t.head = t.tail = null) : (t.head = i, i.data = r.slice(o));
                                break
                            }
                            ++s
                        }
                        ...
                        var i = l.allocUnsafe(e), s = t.head, n = 1;
                        s.data.copy(i), e -= s.data.length;
                        for (; s = s.next;) {
                            var r = s.data, o = e > r.length ? r.length : e;
                            if (r.copy(i, i.length - e, 0, o), 0 === (e -= o)) {
                                o === r.length ? (++n, s.next ? t.head = s.next : t.head = t.tail = null) : (t.head = s, s.data = r.slice(o));
                                break
                            }
                            ++n
                        }
            ...
            y.prototype.read = function (e) {
                ...
                var c = (!t || !1 !== t.end) && e !== s.stdout && e !== s.stderr ? h : y;

                function l(t, s) {
                    p("onunpipe"), t === i && s && !1 === s.hasUnpiped && (s.hasUnpiped = !0, p("cleanup"), e.removeListener("close", E), e.removeListener("finish", _), e.removeListener("drain", u), e.removeListener("error", g), e.removeListener("unpipe", l), i.removeListener("end", h), i.removeListener("end", y), i.removeListener("data", m), d = !0, !r.awaitDrain || e._writableState && !e._writableState.needDrain || u())
                }
                ...
                r.endEmitted ? n.nextTick(c) : i.once("end", c), e.on("unpipe", l);
                var u = function (e) {
                    return function () {
                        var t = e._readableState;
                        p("pipeOnDrain", t.awaitDrain), t.awaitDrain && t.awaitDrain--, 0 === t.awaitDrain && a(e, "data") && (t.flowing = !0, R(e))
                    }
                }(i);
                e.on("drain", u);
                var d = !1;
                ...
                function m(t) {
                    p("ondata"), f = !1, !1 !== e.write(t) || f || ((1 === r.pipesCount && r.pipes === e || r.pipesCount > 1 && -1 !== M(r.pipes, e)) && !d && (p("false write response, pause", i._readableState.awaitDrain), i._readableState.awaitDrain++, f = !0), i.pause())
                }
                ...
                function _() {
                    p("onfinish"), e.removeListener("close", E), y()
                }
                ...
                return i.on("data", m), function (e, t, i) {
                    ...
                    e._events && e._events[t] ? o(e._events[t]) ? e._events[t].unshift(i) : e._events[t] = [i, e._events[t]] : e.on(t, i)
                }(e, "error", g), e.once("close", E), e.once("finish", _), e.emit("pipe", i), r.flowing || (p("pipe resume"), i.resume()), e
            }, y.prototype.unpipe = function (e) {
                var t = this._readableState, i = {hasUnpiped: !1};
                if (0 === t.pipesCount) return this;
                if (1 === t.pipesCount) return e && e !== t.pipes || (e || (e = t.pipes), t.pipes = null, t.pipesCount = 0, t.flowing = !1, e && e.emit("unpipe", this, i)), this;
                if (!e) {
                    var s = t.pipes, n = t.pipesCount;
                    t.pipes = null, t.pipesCount = 0, t.flowing = !1;
                    for (var r = 0; r < n; r++) s[r].emit("unpipe", this, i);
                    return this
                }
                var o = M(t.pipes, e);
                return -1 === o || (t.pipes.splice(o, 1), t.pipesCount -= 1, 1 === t.pipesCount && (t.pipes = t.pipes[0]), e.emit("unpipe", this, i)), this
            }, y.prototype.on = function (e, t) {
                var i = c.prototype.on.call(this, e, t);
                if ("data" === e) !1 !== this._readableState.flowing && this.resume(); else if ("readable" === e) {
                    var s = this._readableState;
                    s.endEmitted || s.readableListening || (s.readableListening = s.needReadable = !0, s.emittedReadable = !1, s.reading ? s.length && A(this) : n.nextTick(D, this))
                }
                return i
                ...
                var t = this, i = this._readableState, s = !1;
                for (var n in e.on("end", (function () {
                    ...
                    (p("wrapped data"), i.decoder && (n = i.decoder.write(n)), i.objectMode && null == n) || (i.objectMode || n && n.length) && (t.push(n) || (s = !0, e.pause()))
                ...
                return this._read = function (t) {
                    p("wrapped _read", t), s && (s = !1, e.resume())
                }, this
        ...
        e.exports = {
            destroy: function (e, t) {
                var i = this, r = this._readableState && this._readableState.destroyed,
                    o = this._writableState && this._writableState.destroyed;
                return r || o ? (t ? t(e) : !e || this._writableState && this._writableState.errorEmitted || s.nextTick(n, this, e), this) : (this._readableState && (this._readableState.destroyed = !0), this._writableState && (this._writableState.destroyed = !0), this._destroy(e || null, (function (e) {
                    !t && e ? (s.nextTick(n, i, e), i._writableState && (i._writableState.errorEmitted = !0)) : t && t(e)
                })), this)
            }, undestroy: function () {
        ...
        "use strict";
        var s = i(33).Buffer, n = s.isEncoding || function (e) {
        ...
        function r(e) {
            ...
            switch (this.encoding = function (e) {
                ...
                if ("string" != typeof t && (s.isEncoding === n || !n(e))) throw new Error("Unknown encoding: " + e);
                return t || e
            }(e), this.encoding) {
                case"utf16le":
            ...
            this.lastNeed = 0, this.lastTotal = 0, this.lastChar = s.allocUnsafe(t)
        }
        ...
        function c(e, t) {
            if ((e.length - t) % 2 == 0) {
                ...
                if (i) {
                    ...
                    if (s >= 55296 && s <= 56319) return this.lastNeed = 2, this.lastTotal = 4, this.lastChar[0] = e[e.length - 2], this.lastChar[1] = e[e.length - 1], i.slice(0, -1)
                }
                return i
            }
        ...
        t.StringDecoder = r, r.prototype.write = function (e) {
            ...
            var i = function (e, t, i) {
                ...
                if (--s < i || -2 === n) return 0;
                if ((n = o(t[s])) >= 0) return n > 0 && (e.lastNeed = n - 2), n;
                if (--s < i || -2 === n) return 0;
                if ((n = o(t[s])) >= 0) return n > 0 && (2 === n ? n = 0 : e.lastNeed = n - 3), n;
                return 0
            }(this, e, t);
            if (!this.lastNeed) return e.toString("utf8", t);
            this.lastTotal = i;
            var s = e.length - (i - this.lastNeed);
        ...
        "use strict";
        e.exports = o;
        var s = i(20), n = Object.create(i(26));
        ...
        function r(e, t) {
            ...
            i.writechunk = null, i.writecb = null, null != t && this.push(t), s(e);
        ...
        n.inherits = i(23), n.inherits(o, s), o.prototype.push = function (e, t) {
            ...
            if (s.writecb = i, s.writechunk = e, s.writeencoding = t, !s.transforming) {
                var n = this._readableState;
                (s.needTransform || n.needReadable || n.length < n.highWaterMark) && this._read(n.highWaterMark)
            }
        ...
        "use strict";
        const s = i(50), {Events: n} = i(0);
        e.exports = class MessageCollector extends s {
            constructor(e, t, i = {}) {
                super(e.client, t, i), this.channel = e, this.received = 0;
                const s = e => {
                    for (const t of e.values()) this.handleDispose(t)
                };
                this._handleChannelDeletion = this._handleChannelDeletion.bind(this), this._handleGuildDeletion = this._handleGuildDeletion.bind(this), this.client.incrementMaxListeners(), this.client.on(n.MESSAGE_CREATE, this.handleCollect), this.client.on(n.MESSAGE_DELETE, this.handleDispose), this.client.on(n.MESSAGE_BULK_DELETE, s), this.client.on(n.CHANNEL_DELETE, this._handleChannelDeletion), this.client.on(n.GUILD_DELETE, this._handleGuildDeletion), this.once("end", () => {
                    this.client.removeListener(n.MESSAGE_CREATE, this.handleCollect), this.client.removeListener(n.MESSAGE_DELETE, this.handleDispose), this.client.removeListener(n.MESSAGE_BULK_DELETE, s), this.client.removeListener(n.CHANNEL_DELETE, this._handleChannelDeletion), this.client.removeListener(n.GUILD_DELETE, this._handleGuildDeletion), this.client.decrementMaxListeners()
                })
            }
        ...
        e.exports = class GuildMemberRoleManager {
            ...
            async add(e, t) {
                if (e instanceof n || Array.isArray(e)) {
                    if ((e = e.map(e => this.guild.roles.resolve(e))).includes(null)) throw new s("INVALID_TYPE", "roles", "Array or Collection of Roles or Snowflakes", !0);
                    const i = [...new Set(e.concat(...this._roles.values()))];
                    return this.set(i, t)
                }
                {
                    if (null === (e = this.guild.roles.resolve(e))) throw new s("INVALID_TYPE", "roles", "Role, Snowflake or Array or Collection of Roles or Snowflakes");
                    await this.client.api.guilds[this.guild.id].members[this.member.id].roles[e.id].put({reason: t});
                    const i = this.member._clone();
                    return i._roles = [...this._roles.keys(), e.id], i
                }
            }
            ...
            async remove(e, t) {
                if (e instanceof n || Array.isArray(e)) {
                    if ((e = e.map(e => this.guild.roles.resolve(e))).includes(null)) throw new s("INVALID_TYPE", "roles", "Array or Collection of Roles or Snowflakes", !0);
                    const i = this._roles.filter(t => !e.includes(t));
                    return this.set(i, t)
                }
                {
                    if (null === (e = this.guild.roles.resolve(e))) throw new s("INVALID_TYPE", "roles", "Array or Collection of Roles or Snowflakes", !0);
                    await this.client.api.guilds[this.guild.id].members[this.member.id].roles[e.id].delete({reason: t});
                    const i = this.member._clone(), n = this._roles.filter(t => t.id !== e.id);
                    return i._roles = [...n.keys()], i
                }
            }
        ...
        "use strict";
        const s = i(5), n = i(75), r = i(2), o = i(7);
        e.exports = class Team extends s {
            constructor(e, t) {
                super(e), this._patch(t)
            }
        ...
        "use strict";
        const s = i(5), {MembershipStates: n} = i(0);
        e.exports = class TeamMember extends s {
            constructor(e, t) {
        ...
        "use strict";
        const s = i(2), {ChannelTypes: n} = i(0), r = i(4);

        class MessageMentions {
            constructor(e, t, i, r, o) {
                if (Object.defineProperty(this, "client", {value: e.client}), Object.defineProperty(this, "guild", {value: e.guild}), Object.defineProperty(this, "_content", {value: e.content}), this.everyone = Boolean(r), t) if (t instanceof s) this.users = new s(t); else {
                    this.users = new s;
                    for (const i of t) {
                        i.member && e.guild && e.guild.members.add(Object.assign(i.member, {user: i}));
                        const t = e.client.users.add(i);
                        this.users.set(t.id, t)
                    }
                } else this.users = new s;
                if (i) if (i instanceof s) this.roles = new s(i); else {
                    this.roles = new s;
                    for (const t of i) {
                        const i = e.channel.guild.roles.cache.get(t);
                        i && this.roles.set(i.id, i)
                    }
                } else this.roles = new s;
                if (this._members = null, this._channels = null, o) if (o instanceof s) this.crosspostedChannels = new s(o); else {
                ...
                } else this.crosspostedChannels = new s
            }

            get members() {
                return this._members ? this._members : this.guild ? (this._members = new s, this.users.forEach(e => {
            ...
            get channels() {
                ...
                let e;
                for (this._channels = new s; null !== (e = this.constructor.CHANNELS_PATTERN.exec(this._content));) {
            ...
            has(e, {ignoreDirect: t = !1, ignoreRoles: s = !1, ignoreEveryone: n = !1} = {}) {
                if (!n && this.everyone) return !0;
                const r = i(10);
                if (!s && e instanceof r) for (const t of this.roles.values()) if (e.roles.cache.has(t.id)) return !0;
                if (!t) {
                    const t = this.client.users.resolveID(e) || this.guild && this.guild.roles.resolveID(e) || this.client.channels.resolveID(e);
        ...
        "use strict";
        const s = i(6), {Error: n} = i(3), r = i(2);
        e.exports = class ReactionUserManager extends s {
            constructor(e, t, i) {
                super(e, t, {name: "User"}), this.reaction = i
            }

            async fetch({limit: e = 100, after: t, before: i} = {}) {
                const s = this.reaction.message,
                    n = await this.client.api.channels[s.channel.id].messages[s.id].reactions[this.reaction.emoji.identifier].get({
                        query: {
                            limit: e,
                            before: i,
                            after: t
            ...
            remove(e = this.reaction.message.client.user) {
                const t = this.reaction.message, i = t.client.users.resolveID(e);
                return i ? t.client.api.channels[t.channel.id].messages[t.id].reactions[this.reaction.emoji.identifier][i === t.client.user.id ? "@me" : i].delete().then(() => this.reaction) : Promise.reject(new n("REACTION_RESOLVE_USER"))
            }
        }
    }, function (e, t, i) {
        "use strict";
        ...
        "use strict";
        const s = i(17), {Error: n} = i(3), r = i(2), {browser: o} = i(0), a = i(8);
        e.exports = class VoiceChannel extends s {
            _patch(e) {
        ...
        "use strict";
        const s = i(17);
        e.exports = class CategoryChannel extends s {
            get children() {
        ...
        "use strict";
        const s = i(42);
        e.exports = class NewsChannel extends s {
            _patch(e) {
        ...
        "use strict";
        const s = i(17);
        e.exports = class StoreChannel extends s {
            _patch(e) {
        ...
        (function (e) {
            var s = Object.getOwnPropertyDescriptors || function (e) {
                for (var t = Object.keys(e), i = {}, s = 0; s < t.length; s++) i[t[s]] = Object.getOwnPropertyDescriptor(e, t[s]);
                return i
            }, n = /%[sdj%]/g;
            t.format = function (e) {
                if (!E(e)) {
                    for (var t = [], i = 0; i < arguments.length; i++) t.push(a(arguments[i]));
                    return t.join(" ")
                }
                i = 1;
                for (var s = arguments, r = s.length, o = String(e).replace(n, (function (e) {
                    if ("%%" === e) return "%";
                    if (i >= r) return e;
                    switch (e) {
                        case"%s":
                ...
                })), c = s[i]; i < r; c = s[++i]) m(c) || !v(c) ? o += " " + c : o += " " + a(c);
                return o
                ...
                return function () {
                    if (!n) {
                        ...
                        e.traceDeprecation ? console.trace(s) : console.error(s), n = !0
                    }
            ...
            function a(e, i) {
                var s = {seen: [], stylize: l};
                return arguments.length >= 3 && (s.depth = arguments[2]), arguments.length >= 4 && (s.colors = arguments[3]), f(i) ? s.showHidden = i : i && t._extend(s, i), _(s.showHidden) && (s.showHidden = !1), _(s.depth) && (s.depth = 2), _(s.colors) && (s.colors = !1), _(s.customInspect) && (s.customInspect = !0), s.colors && (s.stylize = c), h(s, e, s.depth)
            }

            function c(e, t) {
                var i = a.styles[t];
                return i ? "[" + a.colors[i][0] + "m" + e + "[" + a.colors[i][1] + "m" : e
            }
            ...
            function h(e, i, s) {
                ...
                if (r) return r;
                var o = Object.keys(i), a = function (e) {
                    var t = {};
                    return e.forEach((function (e, i) {
                        t[e] = !0
                    })), t
                }(o);
                if (e.showHidden && (o = Object.getOwnPropertyNames(i)), w(i) && (o.indexOf("message") >= 0 || o.indexOf("description") >= 0)) return u(i);
                if (0 === o.length) {
                    if (A(i)) {
                        var c = i.name ? ": " + i.name : "";
                ...
                var l, v = "", S = !1, I = ["{", "}"];
                (p(i) && (S = !0, I = ["[", "]"]), A(i)) && (v = " [Function" + (i.name ? ": " + i.name : "") + "]");
                return y(i) && (v = " " + RegExp.prototype.toString.call(i)), b(i) && (v = " " + Date.prototype.toUTCString.call(i)), w(i) && (v = " " + u(i)), 0 !== o.length || S && 0 != i.length ? s < 0 ? y(i) ? e.stylize(RegExp.prototype.toString.call(i), "regexp") : e.stylize("[Object]", "special") : (e.seen.push(i), l = S ? function (e, t, i, s, n) {
                    for (var r = [], o = 0, a = t.length; o < a; ++o) N(t, String(o)) ? r.push(d(e, t, i, s, String(o), !0)) : r.push("");
                    return n.forEach((function (n) {
                        n.match(/^\d+$/) || r.push(d(e, t, i, s, n, !0))
                    })), r
                }(e, i, s, a, o) : o.map((function (t) {
                    return d(e, i, s, a, t, S)
            ...
            function d(e, t, i, s, n, r) {
                var o, a, c;
                if ((c = Object.getOwnPropertyDescriptor(t, n) || {value: t[n]}).get ? a = c.set ? e.stylize("[Getter/Setter]", "special") : e.stylize("[Getter]", "special") : c.set && (a = e.stylize("[Setter]", "special")), N(s, n) || (o = "[" + n + "]"), a || (e.seen.indexOf(c.value) < 0 ? (a = m(i) ? h(e, c.value, null) : h(e, c.value, i - 1)).indexOf("\n") > -1 && (a = r ? a.split("\n").map((function (e) {
                    return "  " + e
                })).join("\n").substr(2) : "\n" + a.split("\n").map((function (e) {
                    return "   " + e
            ...
            t.debuglog = function (i) {
                if (_(r) && (r = e.env.NODE_DEBUG || ""), i = i.toUpperCase(), !o[i]) if (new RegExp("\\b" + i + "\\b", "i").test(r)) {
                    var s = e.pid;
                    o[i] = function () {
                        var e = t.format.apply(t, arguments);
                        console.error("%s %d: %s", i, s, e)
                    }
                } else o[i] = function () {
                };
                return o[i]
                ...
                return null == e
            }, t.isNumber = g, t.isString = E, t.isSymbol = function (e) {
                return "symbol" == typeof e
            }, t.isUndefined = _, t.isRegExp = y, t.isObject = v, t.isDate = b, t.isError = w, t.isFunction = A, t.isPrimitive = function (e) {
                return null === e || "boolean" == typeof e || "number" == typeof e || "string" == typeof e || "symbol" == typeof e || void 0 === e
            }, t.isBuffer = i(135);
            ...
            }, t.inherits = i(136), t._extend = function (e, t) {
                if (!t || !v(t)) return e;
            ...
            t.promisify = function (e) {
                ...
                function t() {
                    for (var t, i, s = new Promise((function (e, s) {
                        t = e, i = s
                ...
                return Object.setPrototypeOf(i, Object.getPrototypeOf(t)), Object.defineProperties(i, s(t)), i
            }
        }).call(this, i(14))
    }, function (e, t, i) {
        "use strict";
        const s = i(55), n = i(12), r = i(2), {PartialTypes: o} = i(0), a = i(7), c = i(4), l = {
            ALL: "ALL",
            GUILD: "GUILD",
            CHANNEL: "CHANNEL",
            USER: "USER",
        ...
        class GuildAuditLogs {
            constructor(e, t) {
                if (t.users) for (const i of t.users) e.client.users.add(i);
                if (this.webhooks = new r, t.webhooks) for (const i of t.webhooks) this.webhooks.set(i.id, new n(e.client, i));
                if (this.integrations = new r, t.integrations) for (const i of t.integrations) this.integrations.set(i.id, new s(e.client, i, e));
                this.entries = new r;
                for (const i of t.audit_log_entries) {
                    const t = new GuildAuditLogsEntry(this, e, i);
            ...
            constructor(e, t, i) {
                ...
                switch (this.targetType = r, this.actionType = GuildAuditLogs.actionType(i.action_type), this.action = Object.keys(h).find(e => h[e] === i.action_type), this.reason = i.reason || null, this.executor = t.client.options.partials.includes(o.USER) ? t.client.users.add({id: i.user_id}) : t.client.users.cache.get(i.user_id), this.changes = i.changes ? i.changes.map(e => ({
                    ...
                    case h.MESSAGE_BULK_DELETE:
                        this.extra = {
                            channel: t.channels.cache.get(i.options.channel_id) || {id: i.options.channel_id},
                    ...
                    case h.MESSAGE_UNPIN:
                        this.extra = {
                            channel: t.client.channels.cache.get(i.options.channel_id) || {id: i.options.channel_id},
                    ...
                    case h.CHANNEL_OVERWRITE_DELETE:
                        switch (i.options.type) {
                            case"member":
                                this.extra = t.members.cache.get(i.options.id) || {id: i.options.id, type: "member"};
                                break;
                            case"role":
        ...
        "use strict";
        const s = i(6), n = i(17), r = i(43), {ChannelTypes: o} = i(0);
        e.exports = class GuildChannelManager extends s {
            constructor(e, t) {
            ...
            async create(e, t = {}) {
                let {type: i, topic: s, nsfw: n, bitrate: a, userLimit: c, parent: l, permissionOverwrites: h, position: u, rateLimitPerUser: d, reason: p} = t;
                l && (l = this.client.channels.resolveID(l)), h && (h = h.map(e => r.resolve(e, this.guild)));
                const f = await this.client.api.guilds(this.guild.id).channels.post({
                    data: {
                        name: e,
                        topic: s,
                        type: i ? o[i.toUpperCase()] : o.TEXT,
                        nsfw: n,
                        bitrate: a,
                        user_limit: c,
                        parent_id: l,
                ...
                return this.client.actions.ChannelCreate.handle(f).channel
            }
        }
    }, function (e, t, i) {
        "use strict";
        const s = i(6), {Error: n, TypeError: r, RangeError: o} = i(3), a = i(10),
            c = i(2), {Events: l, OPCodes: h} = i(0);
        e.exports = class GuildMemberManager extends s {
            constructor(e, t) {
                super(e.client, t, a), this.guild = e
            }
            ...
            ban(e, t = {days: 0}) {
                ...
                const i = this.client.users.resolveID(e);
                return i ? this.client.api.guilds(this.guild.id).bans[i].put({query: t}).then(() => {
                    if (e instanceof a) return e;
                    const t = this.client.users.resolve(i);
                    if (t) {
            ...
            unban(e, t) {
                const i = this.client.users.resolveID(e);
                return i ? this.client.api.guilds(this.guild.id).bans[i].delete({reason: t}).then(() => this.client.users.resolve(e)) : Promise.reject(new n("BAN_RESOLVE_ID"))
            }

            _fetchSingle({user: e, cache: t}) {
                const i = this.cache.get(e);
                return i && !i.partial ? Promise.resolve(i) : this.client.api.guilds(this.guild.id).members(e).get().then(e => this.add(e, t))
            }

            _fetchMany({limit: e = 0, withPresences: t = !1, user: i, query: s, time: r = 12e4, nonce: a = Date.now().toString(16)} = {}) {
                return new Promise((u, d) => {
                    if (!(this.guild.memberCount !== this.cache.size || s || e || t || i)) return void u(this.cache);
                    if (s || i || (s = ""), a.length > 32) throw new o("MEMBER_FETCH_NONCE_LENGTH");
                    this.guild.shard.send({
                        op: h.REQUEST_GUILD_MEMBERS,
                        d: {guild_id: this.guild.id, presences: t, user_ids: i, query: s, nonce: a, limit: e}
                    });
                    const p = new c, f = s || e || t || i;
                    let m = 0;
                    const g = (t, s, n) => {
                        if (E.refresh(), n.nonce === a) {
                            m++;
                            for (const e of t.values()) f && p.set(e.id, e);
                            if (this.guild.memberCount <= this.cache.size || f && t.size < 1e3 || e && p.size >= e || m === n.count) {
                                this.client.clearTimeout(E), this.client.removeListener(l.GUILD_MEMBERS_CHUNK, g), this.client.decrementMaxListeners();
                                let e = f ? p : this.cache;
                                i && !Array.isArray(i) && e.size && (e = e.first()), u(e)
                            }
                        }
                    }, E = this.client.setTimeout(() => {
                        this.client.removeListener(l.GUILD_MEMBERS_CHUNK, g), this.client.decrementMaxListeners(), d(new n("GUILD_MEMBERS_TIMEOUT"))
                    }, r);
                    this.client.incrementMaxListeners(), this.client.on(l.GUILD_MEMBERS_CHUNK, g)
                })
            }
        }
    }, function (e, t, i) {
        "use strict";
        const s = i(6), {Presence: n} = i(13);
        e.exports = class PresenceManager extends s {
            constructor(e, t) {
                super(e, t, n)
            }

            add(e, t) {
                const i = this.cache.get(e.user.id);
                return i ? i.patch(e) : super.add(e, t, {id: e.user.id})
            }
        ...
        "use strict";
        const s = i(6), n = i(19), r = i(8), {resolveColor: o} = i(4);
        e.exports = class RoleManager extends s {
            constructor(e, t) {
                super(e.client, t, n), this.guild = e
            }
            ...
            async fetch(e, t = !0) {
                ...
                const i = await this.client.api.guilds(this.guild.id).roles.get();
                for (const e of i) this.add(e, t);
            ...
            create({data: e = {}, reason: t} = {}) {
                return e.color && (e.color = o(e.color)), e.permissions && (e.permissions = r.resolve(e.permissions)), this.guild.client.api.guilds(this.guild.id).roles.post({
                    ...
                    const {role: s} = this.client.actions.GuildRoleCreate.handle({guild_id: this.guild.id, role: i});
                    return e.position ? s.setPosition(e.position, t) : s
                })
            }
        ...
        class SystemChannelFlags extends s {
        }
        ...
        "use strict";
        const {Presence: s} = i(13), {TypeError: n} = i(3), r = i(2), {ActivityTypes: o, OPCodes: a} = i(0);
        e.exports = class ClientPresence extends s {
            constructor(e, t = {}) {
            ...
            async set(e) {
                ...
                if (this.patch(t), void 0 === e.shardID) this.client.ws.broadcast({
                    op: a.STATUS_UPDATE,
                    d: t
                }); else if (Array.isArray(e.shardID)) for (const i of e.shardID) this.client.ws.shards.get(i).send({
                    op: a.STATUS_UPDATE,
                    d: t
            ...
            async _parse({status: e, since: t, afk: i, activity: s}) {
                const a = s && (s.application ? s.application.id || s.application : null);
                let c = new r;
                if (s) {
                    if ("string" != typeof s.name) throw new n("INVALID_TYPE", "name", "string");
                    if (s.type || (s.type = 0), s.assets && a) try {
                ...
                const l = {
                    ...
                    game: s ? {
                        ...
                        name: s.name,
                        url: s.url,
                        details: s.details || void 0,
                        state: s.state || void 0,
                        assets: s.assets ? {
                            large_text: s.assets.largeText || void 0,
                            small_text: s.assets.smallText || void 0,
                            large_image: c.get(s.assets.largeImage) || s.assets.largeImage,
                            small_image: c.get(s.assets.smallImage) || s.assets.smallImage
                        } : void 0,
                        timestamps: s.timestamps || void 0,
                        party: s.party || void 0,
                        application_id: a || void 0,
                        secrets: s.secrets || void 0,
                        instance: s.instance || void 0
                    } : null
                };
                return (e || i || t) && !s && (l.game = this.activities[0] || null), l.game && (l.game.type = "number" == typeof l.game.type ? l.game.type : o.indexOf(l.game.type)), l
            }
        }
    }, function (e, t, i) {
        "use strict";
        (function (e) {
            ...
            let n, r;
            try {
                n = i(164), n.pack || (n = null)
            } catch {
            }
            s ? (r = window.TextDecoder, t.WebSocket = window.WebSocket) : (r = i(84).TextDecoder, t.WebSocket = i(165));
            const o = new r;
            t.encoding = n ? "etf" : "json", t.pack = n ? n.pack : JSON.stringify, t.unpack = (i, s) => "json" === t.encoding || "json" === s ? ("string" != typeof i && (i = o.decode(i)), JSON.parse(i)) : (e.isBuffer(i) || (i = e.from(new Uint8Array(i))), n.unpack(i)), t.create = (e, i = {}, ...n) => {
                const [r, o] = e.split("?");
                i.encoding = t.encoding, i = new URLSearchParams(i), o && new URLSearchParams(o).forEach((e, t) => i.set(t, e));
                const a = new t.WebSocket(`${r}?${i}`, ...n);
                return s && (a.binaryType = "arraybuffer"), a
            };
            for (const e of ["CONNECTING", "OPEN", "CLOSING", "CLOSED"]) t[e] = t.WebSocket[e]
        }).call(this, i(21).Buffer)
    }, function (e, t, i) {
        "use strict";
        const {WSEvents: s} = i(0), n = {};
        for (const e of Object.keys(s)) try {
            n[e] = i(167)(`./${e}.js`)
        } catch {
        }
        e.exports = n
        ...
        class ClientUser extends (n.get("User")) {
            ...
            async setAvatar(e) {
                return this.edit({avatar: await s.resolveImage(e)})
            }
            ...
            setActivity(e, t = {}) {
                ...
                const i = Object.assign({}, t, "object" == typeof e ? e : {name: e});
                return this.setPresence({activity: i, shardID: i.shardID})
            }
        ...
        "use strict";
        const s = i(6), n = i(16), {Events: r} = i(0);
        e.exports = class ChannelManager extends s {
            constructor(e, t) {
                super(e, t, n)
            }

            add(e, t, i = !0) {
                const s = this.cache.get(e.id);
                if (s) return s._patch && i && s._patch(e), t && t.channels.add(s), s;
                const o = n.create(this.client, e, t);
                return o ? (i && this.cache.set(o.id, o), o) : (this.client.emit(r.DEBUG, `Failed to find guild, or unknown type for channel ${e.id} ${e.type}`), null)
            }
            ...
            async fetch(e, t = !0) {
                const i = this.cache.get(e);
                if (i && !i.partial) return i;
                const s = await this.client.api.channels(e).get();
                return this.add(s, null, t)
            }
        }
    }, function (e, t, i) {
        "use strict";
        const s = i(6), n = i(54), r = i(17), o = i(25), a = i(10), c = i(18),
            l = i(19), {Events: h, VerificationLevels: u, DefaultMessageNotifications: d, ExplicitContentFilterLevels: p} = i(0),
            f = i(9), m = i(8), {resolveColor: g} = i(4);
        e.exports = class GuildManager extends s {
            constructor(e, t) {
                super(e, t, n)
            }
            ...
            async create(e, {channels: t = [], defaultMessageNotifications: i, explicitContentFilter: s, icon: n = null, region: r, roles: o = [], verificationLevel: a} = {}) {
                n = await f.resolveImage(n), void 0 !== a && "number" != typeof a && (a = u.indexOf(a)), void 0 !== i && "number" != typeof i && (i = d.indexOf(i)), void 0 !== s && "number" != typeof s && (s = p.indexOf(s));
                for (const e of t) if (e.parent_id = e.parentID, delete e.parentID, e.permissionOverwrites) {
                    for (const t of e.permissionOverwrites) t.allow && (t.allow = m.resolve(t.allow)), t.deny && (t.deny = m.resolve(t.deny));
                    e.permission_overwrites = e.permissionOverwrites, delete e.permissionOverwrites
                }
                for (const e of o) e.color && (e.color = g(e.color)), e.permissions && (e.permissions = m.resolve(e.permissions));
                return new Promise((c, l) => this.client.api.guilds.post({
                    ...
                    const t = s => {
                        s.id === e.id && (this.client.clearTimeout(i), this.client.removeListener(h.GUILD_CREATE, t), this.client.decrementMaxListeners(), c(s))
                    };
                    this.client.incrementMaxListeners(), this.client.on(h.GUILD_CREATE, t);
                    const i = this.client.setTimeout(() => {
                        this.client.removeListener(h.GUILD_CREATE, t), this.client.decrementMaxListeners(), c(this.client.guilds.add(e))
                    }, 1e4)
                }, l))
            }
        }
        ...
        "use strict";
        const s = i(6), n = i(10), r = i(29), o = i(27);
        e.exports = class UserManager extends s {
            constructor(e, t) {
                super(e, t, o)
            }
            ...
            async fetch(e, t = !0) {
                const i = this.cache.get(e);
                if (i && !i.partial) return i;
                const s = await this.client.api.users(e).get();
                return this.add(s, t)
            }
        }
    }, function (e, t, i) {
        ...
        e.exports = {
            ...
            Client: i(111),
            Shard: i(206),
            ShardClientUtil: i(207),
            ShardingManager: i(208),
            WebhookClient: i(49),
            ActivityFlags: i(71),
            BitField: i(11),
            Collection: i(2),
            ...
            SnowflakeUtil: i(7),
            Structures: i(24),
            SystemChannelFlags: i(90),
            UserFlags: i(79),
            Util: s,
            version: i(60).version,
            ChannelManager: i(95),
            GuildChannelManager: i(86),
            GuildEmojiManager: i(58),
            GuildEmojiRoleManager: i(65),
            GuildMemberManager: i(87),
            GuildMemberRoleManager: i(73),
            GuildManager: i(96),
            ReactionUserManager: i(78),
            MessageManager: i(35),
            PresenceManager: i(88),
            RoleManager: i(89),
            UserManager: i(97),
            discordSort: s.discordSort,
            escapeMarkdown: s.escapeMarkdown,
            fetchRecommendedShards: s.fetchRecommendedShards,
            resolveColor: s.resolveColor,
            resolveString: s.resolveString,
            splitMessage: s.splitMessage,
            Base: i(5),
            Activity: i(13).Activity,
            APIMessage: i(31),
            BaseGuildEmoji: i(41),
            CategoryChannel: i(81),
            Channel: i(16),
            ClientApplication: i(51),
            get ClientUser() {
                return i(94)
            },
            Collector: i(50),
            ...
            Invite: i(18),
            Message: i(29),
            MessageAttachment: i(44),
            MessageCollector: i(72),
            MessageEmbed: i(45),
            MessageMentions: i(76),
            MessageReaction: i(52),
            NewsChannel: i(82),
            PermissionOverwrites: i(43),
            Presence: i(13).Presence,
            ClientPresence: i(91),
            ReactionCollector: i(77),
            ReactionEmoji: i(53),
            RichPresenceAssets: i(13).RichPresenceAssets,
            Role: i(19),
            StoreChannel: i(83),
            Team: i(74),
            TeamMember: i(75),
        ...
        t.byteLength = function (e) {
            var t = l(e), i = t[0], s = t[1];
            return 3 * (i + s) / 4 - s
        }, t.toByteArray = function (e) {
            var t, i, s = l(e), o = s[0], a = s[1], c = new r(function (e, t, i) {
                return 3 * (t + i) / 4 - i
            }(0, o, a)), h = 0, u = a > 0 ? o - 4 : o;
            for (i = 0; i < u; i += 4) t = n[e.charCodeAt(i)] << 18 | n[e.charCodeAt(i + 1)] << 12 | n[e.charCodeAt(i + 2)] << 6 | n[e.charCodeAt(i + 3)], c[h++] = t >> 16 & 255, c[h++] = t >> 8 & 255, c[h++] = 255 & t;
            2 === a && (t = n[e.charCodeAt(i)] << 2 | n[e.charCodeAt(i + 1)] >> 4, c[h++] = 255 & t);
            1 === a && (t = n[e.charCodeAt(i)] << 10 | n[e.charCodeAt(i + 1)] << 4 | n[e.charCodeAt(i + 2)] >> 2, c[h++] = t >> 8 & 255, c[h++] = 255 & t);
            return c
        }, t.fromByteArray = function (e) {
            for (var t, i = e.length, n = i % 3, r = [], o = 0, a = i - n; o < a; o += 16383) r.push(h(e, o, o + 16383 > a ? a : o + 16383));
            1 === n ? (t = e[i - 1], r.push(s[t >> 2] + s[t << 4 & 63] + "==")) : 2 === n && (t = (e[i - 2] << 8) + e[i - 1], r.push(s[t >> 10] + s[t >> 4 & 63] + s[t << 2 & 63] + "="));
            return r.join("")
        };
        for (var s = [], n = [], r = "undefined" != typeof Uint8Array ? Uint8Array : Array, o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", a = 0, c = o.length; a < c; ++a) s[a] = o[a], n[o.charCodeAt(a)] = a;
        ...
        function h(e, t, i) {
            for (var n, r, o = [], a = t; a < i; a += 3) n = (e[a] << 16 & 16711680) + (e[a + 1] << 8 & 65280) + (255 & e[a + 2]), o.push(s[(r = n) >> 18 & 63] + s[r >> 12 & 63] + s[r >> 6 & 63] + s[63 & r]);
            return o.join("")
        }
        ...
        t.read = function (e, t, i, s, n) {
            var r, o, a = 8 * n - s - 1, c = (1 << a) - 1, l = c >> 1, h = -7, u = i ? n - 1 : 0, d = i ? -1 : 1,
                p = e[t + u];
            for (u += d, r = p & (1 << -h) - 1, p >>= -h, h += a; h > 0; r = 256 * r + e[t + u], u += d, h -= 8) ;
            for (o = r & (1 << -h) - 1, r >>= -h, h += s; h > 0; o = 256 * o + e[t + u], u += d, h -= 8) ;
            if (0 === r) r = 1 - l; else {
                if (r === c) return o ? NaN : 1 / 0 * (p ? -1 : 1);
                o += Math.pow(2, s), r -= l
            }
            return (p ? -1 : 1) * o * Math.pow(2, r - s)
        }, t.write = function (e, t, i, s, n, r) {
            var o, a, c, l = 8 * r - n - 1, h = (1 << l) - 1, u = h >> 1,
                d = 23 === n ? Math.pow(2, -24) - Math.pow(2, -77) : 0, p = s ? 0 : r - 1, f = s ? 1 : -1,
                m = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
            for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (a = isNaN(t) ? 1 : 0, o = h) : (o = Math.floor(Math.log(t) / Math.LN2), t * (c = Math.pow(2, -o)) < 1 && (o--, c *= 2), (t += o + u >= 1 ? d / c : d * Math.pow(2, 1 - u)) * c >= 2 && (o++, c /= 2), o + u >= h ? (a = 0, o = h) : o + u >= 1 ? (a = (t * c - 1) * Math.pow(2, n), o += u) : (a = t * Math.pow(2, u - 1) * Math.pow(2, n), o = 0)); n >= 8; e[i + p] = 255 & a, p += f, a /= 256, n -= 8) ;
            for (o = o << n | a, l += n; l > 0; e[i + p] = 255 & o, p += f, o /= 256, l -= 8) ;
            e[i + p - f] |= 128 * m
        }
    }, function (e, t, i) {
        "use strict";
        const {register: s} = i(61), n = {
            ...
            INVALID_TYPE: (e, t, i = !1) => `Supplied ${e} is not a${i ? "n" : ""} ${t}.`,
        ...
        for (const [e, t] of Object.entries(n)) s(e, t)
    }, function (e, t, i) {
        "use strict";
        ...
        class Collection extends Map {
            ...
            find(e, t) {
                void 0 !== t && (e = e.bind(t));
                for (const [t, i] of this) if (e(i, t, this)) return i
            }

            findKey(e, t) {
                void 0 !== t && (e = e.bind(t));
                for (const [t, i] of this) if (e(i, t, this)) return t
            }

            sweep(e, t) {
                void 0 !== t && (e = e.bind(t));
                const i = this.size;
                for (const [t, i] of this) e(i, t, this) && this.delete(t);
                return i - this.size
            }
            ...
            filter(e, t) {
                ...
                for (const [t, s] of this) e(s, t, this) && i.set(t, s);
                return i
            }

            partition(e, t) {
                void 0 !== t && (e = e.bind(t));
                const i = [new this.constructor[Symbol.species], new this.constructor[Symbol.species]];
                for (const [t, s] of this) e(s, t, this) ? i[0].set(t, s) : i[1].set(t, s);
                return i
            }
            ...
            some(e, t) {
                void 0 !== t && (e = e.bind(t));
                for (const [t, i] of this) if (e(i, t, this)) return !0;
                return !1
            }

            every(e, t) {
                void 0 !== t && (e = e.bind(t));
                for (const [t, i] of this) if (!e(i, t, this)) return !1;
                return !0
            }
            ...
            reduce(e, t) {
                ...
                let s = !0;
                for (const [t, n] of this) s ? (i = n, s = !1) : i = e(i, n, t, this);
                if (s) throw new TypeError("Reduce of empty collection with no initial value");
                return i
            }
            ...
            concat(...e) {
                const t = this.clone();
                for (const i of e) for (const [e, s] of i) t.set(e, s);
                return t
            }
            ...
            equals(e) {
                ...
                for (const [t, i] of this) if (!e.has(t) || i !== e.get(t)) return !1;
                return !0
            }

            sort(e = ((e, t) => Number(e > t) || Number(e === t) - 1)) {
                const t = [...this.entries()];
                t.sort((t, i) => e(t[1], i[1], t[0], i[0])), super.clear(), this._array = null, this._keyArray = null;
                for (const [e, i] of t) super.set(e, i);
                return this
            }
            ...
            difference(e) {
                return e.filter((e, t) => !this.has(t)).concat(this.filter((t, i) => !e.has(i)))
            }

            sorted(e = ((e, t) => Number(e > t) || Number(e === t) - 1)) {
                return new this.constructor[Symbol.species]([...this.entries()]).sort((t, i, s, n) => e(t, i, s, n))
            }
        }
        ...
        "use strict";
        const s = i(105), n = i(109), r = i(110), {Error: o} = i(3), a = i(2), {Endpoints: c} = i(0);
        e.exports = class RESTManager {
            ...
            push(e, t) {
                return new Promise((i, s) => {
                    e.push({request: t, resolve: i, reject: s, retries: 0}).catch(s)
                })
            }

            request(e, t, i = {}) {
                const n = new s(this, e, t, i);
        ...
        "use strict";
        const s = i(106), n = i(107), r = i(108), o = i(37), {browser: a, UserAgent: c} = i(0);
        if (s.Agent) var l = new s.Agent({keepAlive: !0});
        e.exports = class APIRequest {
            constructor(e, t, i, s) {
                this.rest = e, this.client = e.client, this.method = t, this.route = s.route, this.options = s;
                let n = "";
                if (s.query) {
                    const e = Object.entries(s.query).filter(([, e]) => ![null, "null", "undefined"].includes(e) && void 0 !== e).flatMap(([e, t]) => Array.isArray(t) ? t.map(t => [e, t]) : [[e, t]]);
            ...
            make() {
                ...
                let t, i = {};
                if (!1 !== this.options.auth && (i.Authorization = this.rest.getAuth()), this.options.reason && (i["X-Audit-Log-Reason"] = encodeURIComponent(this.options.reason)), a || (i["User-Agent"] = c), this.options.headers && (i = Object.assign(i, this.options.headers)), this.options.files && this.options.files.length) {
                    t = new n;
                    for (const e of this.options.files) e && e.file && t.append(e.name, e.file, e.name);
                    void 0 !== this.options.data && t.append("payload_json", JSON.stringify(this.options.data)), a || (i = Object.assign(i, t.getHeaders()))
                } else null != this.options.data && (t = JSON.stringify(this.options.data), i["Content-Type"] = "application/json");
                const s = new r, h = this.client.setTimeout(() => s.abort(), this.client.options.restRequestTimeout);
                return o(e, {
                    method: this.method,
                    headers: i,
                    agent: l,
        ...
        "use strict";
        const {AbortController: s, AbortSignal: n} = "undefined" != typeof self ? self : "undefined" != typeof window ? window : void 0;
        e.exports = s, e.exports.AbortSignal = n, e.exports.default = s
    }, function (e, t, i) {
        "use strict";
        const s = () => {
        ...
        e.exports = function (e) {
            const t = [""], i = {
                get(o, a) {
                    ...
                    if (n.includes(a)) {
                        const i = [];
                        for (let e = 0; e < t.length && "reactions" !== t[e - 1]; e++) /\d{16,19}/g.test(t[e]) && !/channels|guilds/.test(t[e - 1]) ? i.push(":id") : i.push(t[e]);
                        return s => e.request(a, t.join("/"), Object.assign({
                            versioned: e.versioned,
                            route: i.join("/")
                        }, s))
                    }
                    return t.push(a), new Proxy(s, i)
                }, apply: (e, n, r) => (t.push(...r.filter(e => null != e)), new Proxy(s, i))
            };
            return new Proxy(s, i)
        }
    }, function (e, t, i) {
        "use strict";
        const s = i(63), n = i(64), {Events: {RATE_LIMIT: r}, browser: o} = i(0), a = i(4);
        ...
        e.exports = class RequestHandler {
            ...
            async execute(e) {
                ...
                this.busy = !0;
                const {reject: t, request: i, resolve: o} = e;
                if (this.limited) {
                ...
                try {
                    ...
                    return this.busy = !1, t(new n(e.message, e.constructor.name, e.status, i.method, i.path))
                }
                if (h && h.headers) {
                    const t = h.headers.get("date"), i = h.headers.get("x-ratelimit-limit"),
                        s = h.headers.get("x-ratelimit-remaining"), n = h.headers.get("x-ratelimit-reset"),
                        r = h.headers.get("retry-after");
                    this.limit = i ? Number(i) : 1 / 0, this.remaining = s ? Number(s) : 1, this.reset = n ? function (e, t) {
                ...
                if (h.status >= 500 && h.status < 600) return e.retries === this.manager.client.options.retryLimit ? t(new n(h.statusText, h.constructor.name, h.status, e.request.method, i.path)) : (e.retries++, this.queue.unshift(e), this.run());
                try {
                    const e = await c(h);
                    return h.status >= 400 && h.status < 500 ? t(new s(i.path, e, i.method, h.status)) : null
                } catch (e) {
                    return t(new n(e.message, e.constructor.name, e.status, i.method, i.path))
                }
            }
        }
        ...
        "use strict";
        (function (process) {
            const BaseClient = __webpack_require__(38), ActionsManager = __webpack_require__(112),
                ClientVoiceManager = __webpack_require__(161),
                WebSocketManager = __webpack_require__(162), {Error: Error, TypeError: TypeError, RangeError: RangeError} = __webpack_require__(3),
                ChannelManager = __webpack_require__(95), GuildEmojiManager = __webpack_require__(58),
                GuildManager = __webpack_require__(96), UserManager = __webpack_require__(97),
                ShardClientUtil = __webpack_require__(204), ClientApplication = __webpack_require__(51),
                GuildPreview = __webpack_require__(56), Invite = __webpack_require__(18),
                VoiceRegion = __webpack_require__(57), Webhook = __webpack_require__(12),
                Collection = __webpack_require__(2), {Events: Events, browser: browser, DefaultOptions: DefaultOptions} = __webpack_require__(0),
                DataResolver = __webpack_require__(9), Intents = __webpack_require__(98),
                Permissions = __webpack_require__(8), Structures = __webpack_require__(24);
            ...
            class Client extends BaseClient {
                constructor(e = {}) {
                    ...
                    let t = process.env;
                    try {
                        t = __webpack_require__(205).workerData || t
                    } catch {
                    }
                    ...
                    const i = typeof this.options.shards;
                    ...
                    const s = Structures.get("ClientPresence");
                    this.presence = new s(this), Object.defineProperty(this, "token", {writable: !0}), browser || this.token || !("DISCORD_TOKEN" in process.env) ? this.token = null : this.token = process.env.DISCORD_TOKEN, this.user = null, this.readyAt = null, this.options.messageSweepInterval > 0 && this.setInterval(this.sweepMessages.bind(this), 1e3 * this.options.messageSweepInterval)
                }

                get emojis() {
                    const e = new GuildEmojiManager({client: this});
                    for (const t of this.guilds.cache.values()) if (t.available) for (const i of t.emojis.cache.values()) e.cache.set(i.id, i);
                    return e
                }
                ...
                sweepMessages(e = this.options.messageCacheLifetime) {
                    ...
                    const t = 1e3 * e, i = Date.now();
                    let s = 0, n = 0;
                    for (const e of this.channels.cache.values()) e.messages && (s++, n += e.messages.cache.sweep(e => i - (e.editedTimestamp || e.createdTimestamp) > t));
                    return this.emit(Events.DEBUG, `Swept ${n} messages older than ${e} seconds in ${s} text-based channels`), n
                }
                ...
                async generateInvite(e) {
                    ...
                    const t = await this.fetchApplication(),
                        i = new URLSearchParams({client_id: t.id, permissions: e, scope: "bot"});
                    return `${this.options.http.api}${this.api.oauth2.authorize}?${i}`
                }
        ...
        e.exports = class ActionsManager {
            constructor(e) {
                this.client = e, this.register(i(113)), this.register(i(114)), this.register(i(115)), this.register(i(116)), this.register(i(117)), this.register(i(118)), this.register(i(119)), this.register(i(120)), this.register(i(121)), this.register(i(122)), this.register(i(140)), this.register(i(141)), this.register(i(142)), this.register(i(143)), this.register(i(144)), this.register(i(145)), this.register(i(146)), this.register(i(147)), this.register(i(148)), this.register(i(149)), this.register(i(150)), this.register(i(151)), this.register(i(152)), this.register(i(153)), this.register(i(154)), this.register(i(155)), this.register(i(156)), this.register(i(157)), this.register(i(158)), this.register(i(159)), this.register(i(160))
            }
        ...
        "use strict";
        const s = i(1), {Events: n} = i(0);
        e.exports = class MessageCreateAction extends s {
            handle(e) {
                const t = this.client, i = t.channels.cache.get(e.channel_id);
                if (i) {
                    const s = i.messages.cache.get(e.id);
                    if (s) return {message: s};
                    const r = i.messages.add(e), o = r.author;
                    let a = r.member;
                    return i.lastMessageID = e.id, o && (o.lastMessageID = e.id, o.lastMessageChannelID = i.id), a && (a.lastMessageID = e.id, a.lastMessageChannelID = i.id), t.emit(n.MESSAGE_CREATE, r), {message: r}
                }
                return {}
            }
        }
        ...
        "use strict";
        const s = i(1), {Events: n} = i(0);
        e.exports = class MessageDeleteAction extends s {
            handle(e) {
                const t = this.client, i = this.getChannel(e);
                let s;
                return i && (s = this.getMessage(e, i), s && (i.messages.cache.delete(s.id), s.deleted = !0, t.emit(n.MESSAGE_DELETE, s))), {message: s}
            }
        }
    }, function (e, t, i) {
        "use strict";
        const s = i(1), n = i(2), {Events: r} = i(0);
        e.exports = class MessageDeleteBulkAction extends s {
            handle(e) {
                const t = this.client, i = t.channels.cache.get(e.channel_id);
                if (i) {
                    const s = e.ids, o = new n;
                    for (const t of s) {
                        const s = this.getMessage({id: t, guild_id: e.guild_id}, i, !1);
                        s && (s.deleted = !0, o.set(s.id, s), i.messages.cache.delete(t))
                    }
        ...
        "use strict";
        const s = i(1);
        e.exports = class MessageUpdateAction extends s {
            handle(e) {
                const t = this.getChannel(e);
                if (t) {
                    const {id: i, channel_id: s, guild_id: n, author: r, timestamp: o, type: a} = e,
                        c = this.getMessage({id: i, channel_id: s, guild_id: n, author: r, timestamp: o, type: a}, t);
        ...
        "use strict";
        const s = i(1), {Events: n} = i(0), {PartialTypes: r} = i(0);
        e.exports = class MessageReactionAdd extends s {
            handle(e) {
                if (!e.emoji) return !1;
                const t = this.getUser(e);
                if (!t) return !1;
                const i = this.getChannel(e);
                if (!i || "voice" === i.type) return !1;
                const s = this.getMessage(e, i);
                if (!s) return !1;
                if (s.partial && !this.client.options.partials.includes(r.REACTION)) return !1;
                const o = s.reactions.add({
                    emoji: e.emoji,
                    count: s.partial ? null : 0,
        ...
        "use strict";
        const s = i(1), {Events: n} = i(0);
        e.exports = class MessageReactionRemove extends s {
            handle(e) {
                if (!e.emoji) return !1;
                const t = this.getUser(e);
                if (!t) return !1;
        ...
        "use strict";
        const s = i(1), {Events: n} = i(0);
        e.exports = class MessageReactionRemoveAll extends s {
            handle(e) {
                const t = this.getChannel(e);
                if (!t || "voice" === t.type) return !1;
                const i = this.getMessage(e, t);
                return !!i && (i.reactions.cache.clear(), this.client.emit(n.MESSAGE_REACTION_REMOVE_ALL, i), {message: i})
            }
        }
    }, function (e, t, i) {
        "use strict";
        const s = i(1), {Events: n} = i(0);
        e.exports = class MessageReactionRemoveEmoji extends s {
            handle(e) {
                const t = this.getChannel(e);
                if (!t || "voice" === t.type) return !1;
                const i = this.getMessage(e, t);
                ...
                return !!s && (i.partial || i.reactions.cache.delete(s.emoji.id || s.emoji.name), this.client.emit(n.MESSAGE_REACTION_REMOVE_EMOJI, s), {reaction: s})
            }
        }
    }, function (e, t, i) {
        "use strict";
        const s = i(1), {Events: n} = i(0);
        e.exports = class ChannelCreateAction extends s {
            handle(e) {
                const t = this.client, i = t.channels.cache.has(e.id), s = t.channels.add(e);
                return !i && s && t.emit(n.CHANNEL_CREATE, s), {channel: s}
            }
        }
    }, function (e, t, i) {
        "use strict";
        const s = i(1), n = i(40), {Events: r} = i(0);
        e.exports = class ChannelDeleteAction extends s {
            constructor(e) {
            ...
            handle(e) {
                ...
                if (i) {
                    if (t.channels.remove(i.id), i.deleted = !0, i.messages && !(i instanceof n)) for (const e of i.messages.cache.values()) e.deleted = !0;
                    t.emit(r.CHANNEL_DELETE, i)
                }
                return {channel: i}
            }
        }
        ...
        e.exports = n;
        var s = i(15).EventEmitter;

        function n() {
            s.call(this)
        }

        i(23)(n, s), n.Readable = i(46), n.Writable = i(129), n.Duplex = i(130), n.Transform = i(131), n.PassThrough = i(132), n.Stream = n, n.prototype.pipe = function (e, t) {
            var i = this;
            ...
            i.on("data", n), e.on("drain", r), e._isStdio || t && !1 === t.end || (i.on("end", a), i.on("close", c));
            var o = !1;
            ...
            function l(e) {
                if (h(), 0 === s.listenerCount(this, "error")) throw e
            }

            function h() {
                i.removeListener("data", n), e.removeListener("drain", r), i.removeListener("end", a), i.removeListener("close", c), i.removeListener("error", l), e.removeListener("error", l), i.removeListener("end", h), i.removeListener("close", h), e.removeListener("close", h)
            }

            return i.on("error", l), e.on("error", l), i.on("end", h), i.on("close", h), e.on("close", h), e.emit("pipe", i), e
        }
    }, function (e, t) {
    }, function (e, t, i) {
        "use strict";
        var s = i(33).Buffer, n = i(126);
        e.exports = function () {
            function e() {
                !function (e, t) {
            ...
            return e.prototype.push = function (e) {
                ...
                for (var t, i, n, r = s.allocUnsafe(e >>> 0), o = this.head, a = 0; o;) t = o.data, i = r, n = a, t.copy(i, n), a += o.data.length, o = o.next;
                return r
            }, e
            ...
            e.exports = function (e, t) {
                ...
                return function () {
                    if (!s) {
                        ...
                        i("traceDeprecation") ? console.trace(t) : console.warn(t), s = !0
                    }
        ...
        "use strict";
        e.exports = r;
        var s = i(70), n = Object.create(i(26));
        ...
        n.inherits = i(23), n.inherits(r, s), r.prototype._transform = function (e, t, i) {
            i(null, e)
        }
    }, function (e, t, i) {
        e.exports = i(47)
        ...
        e.exports = i(46).Transform
    }, function (e, t, i) {
        e.exports = i(46).PassThrough
    }, function (e, t, i) {
        "use strict";
        const s = i(6), n = i(52);
        e.exports = class ReactionManager extends s {
            constructor(e, t) {
        ...
        "use strict";
        const s = i(41);
        e.exports = class GuildPreviewEmoji extends s {
            get roles() {
        ...
        "use strict";
        const s = i(6), n = i(28);
        e.exports = class VoiceStateManager extends s {
            constructor(e, t) {
                super(e.client, t, n), this.guild = e
            }
            ...
            add(e, t = !0) {
                ...
                const s = new n(this.guild, e);
                return t && this.cache.set(e.user_id, s), s
            }
        }
    }, function (e, t, i) {
        "use strict";
        const s = i(16), {Error: n} = i(3);
        e.exports = class PartialGroupDMChannel extends s {
            constructor(e, t) {
        ...
        "use strict";
        const s = i(1), n = i(16), {ChannelTypes: r} = i(0);
        e.exports = class ChannelUpdateAction extends s {
            handle(e) {
                let t = this.client.channels.cache.get(e.id);
                if (t) {
                    const i = t._update(e);
                    if (r[t.type.toUpperCase()] !== e.type) {
                        const i = n.create(this.client, e, t.guild);
                        for (const [e, s] of t.messages.cache) i.messages.cache.set(e, s);
                        i._typing = new Map(t._typing), t = i, this.client.channels.cache.set(t.id, t)
                    }
                    return {old: i, updated: t}
                }
                return {}
            }
        }
        ...
        "use strict";
        const s = i(1), {Events: n} = i(0);
        e.exports = class GuildDeleteAction extends s {
            constructor(e) {
                super(e), this.deleted = new Map
            }
            ...
            handle(e) {
                ...
                if (i) {
                    for (const e of i.channels.cache.values()) "text" === e.type && e.stopTyping(!0);
                    if (e.unavailable) return i.available = !1, t.emit(n.GUILD_UNAVAILABLE, i), {guild: null};
                    for (const e of i.channels.cache.values()) this.client.channels.remove(e.id);
                    i.voice && i.voice.connection && i.voice.connection.disconnect(), t.guilds.cache.delete(i.id), i.deleted = !0, t.emit(n.GUILD_DELETE, i), this.deleted.set(i.id, i), this.scheduleForDeletion(i.id)
                } else i = this.deleted.get(e.id) || null;
                return {guild: i}
            }
        ...
        "use strict";
        const s = i(1), {Events: n} = i(0);
        e.exports = class GuildUpdateAction extends s {
            handle(e) {
                const t = this.client, i = t.guilds.cache.get(e.id);
                if (i) {
                    const s = i._update(e);
                    return t.emit(n.GUILD_UPDATE, s, i), {old: s, updated: i}
                }
        ...
        "use strict";
        const s = i(1), n = i(18), {Events: r} = i(0);
        e.exports = class InviteCreateAction extends s {
            handle(e) {
                const t = this.client, i = t.channels.cache.get(e.channel_id), s = t.guilds.cache.get(e.guild_id);
                if (!i && !s) return !1;
                const o = Object.assign(e, {channel: i, guild: s}), a = new n(t, o);
        ...
        "use strict";
        const s = i(1), n = i(18), {Events: r} = i(0);
        e.exports = class InviteDeleteAction extends s {
            handle(e) {
                const t = this.client, i = t.channels.cache.get(e.channel_id), s = t.guilds.cache.get(e.guild_id);
                if (!i && !s) return !1;
                const o = Object.assign(e, {channel: i, guild: s}), a = new n(t, o);
        ...
        "use strict";
        const s = i(1), {Events: n, Status: r} = i(0);
        e.exports = class GuildMemberRemoveAction extends s {
            handle(e, t) {
                const i = this.client, s = i.guilds.cache.get(e.guild_id);
                let o = null;
                return s && (o = this.getMember(e, s), s.memberCount--, o && (o.deleted = !0, s.members.cache.delete(o.id), t.status === r.READY && i.emit(n.GUILD_MEMBER_REMOVE, o)), s.voiceStates.cache.delete(e.user.id)), {
                    guild: s,
                    member: o
                }
            }
        ...
        "use strict";
        const s = i(1), {Events: n} = i(0);
        e.exports = class GuildBanRemove extends s {
            handle(e) {
                const t = this.client, i = t.guilds.cache.get(e.guild_id), s = t.users.add(e.user);
                i && s && t.emit(n.GUILD_BAN_REMOVE, i, s)
            }
        }
    }, function (e, t, i) {
        "use strict";
        const s = i(1), {Events: n} = i(0);
        e.exports = class GuildRoleCreate extends s {
            handle(e) {
                const t = this.client, i = t.guilds.cache.get(e.guild_id);
                let s;
                if (i) {
                    const r = i.roles.cache.has(e.role.id);
                    s = i.roles.add(e.role), r || t.emit(n.GUILD_ROLE_CREATE, s)
                }
                return {role: s}
            }
        }
        ...
        "use strict";
        const s = i(1), {Events: n} = i(0);
        e.exports = class GuildRoleDeleteAction extends s {
            handle(e) {
                const t = this.client, i = t.guilds.cache.get(e.guild_id);
                let s;
                return i && (s = i.roles.cache.get(e.role_id), s && (i.roles.cache.delete(e.role_id), s.deleted = !0, t.emit(n.GUILD_ROLE_DELETE, s))), {role: s}
            }
        }
    }, function (e, t, i) {
        "use strict";
        const s = i(1), {Events: n} = i(0);
        e.exports = class GuildRoleUpdateAction extends s {
            handle(e) {
                const t = this.client, i = t.guilds.cache.get(e.guild_id);
                if (i) {
                    let s = null;
                    const r = i.roles.cache.get(e.role.id);
                    return r && (s = r._update(e.role), t.emit(n.GUILD_ROLE_UPDATE, s, r)), {old: s, updated: r}
                }
                return {old: null, updated: null}
            }
        }
        ...
        "use strict";
        const s = i(1), {Events: n} = i(0);
        e.exports = class PresenceUpdateAction extends s {
            handle(e) {
                ...
                if (!i) return;
                let s = i.presences.cache.get(t.id);
                s && (s = s._clone());
                let r = i.members.cache.get(t.id);
                r || "offline" === e.status || (r = i.members.add({
                    user: t,
                    roles: e.roles,
                    deaf: !1,
                    mute: !1
                }), this.client.emit(n.GUILD_MEMBER_AVAILABLE, r)), i.presences.add(Object.assign(e, {guild: i})), r && this.client.listenerCount(n.PRESENCE_UPDATE) && this.client.emit(n.PRESENCE_UPDATE, s, r.presence)
            }
        }
    }, function (e, t, i) {
        "use strict";
        const s = i(1), {Events: n} = i(0);
        e.exports = class UserUpdateAction extends s {
            handle(e) {
                const t = this.client, i = t.users.cache.get(e.id), s = i._update(e);
                return s.equals(i) ? {old: null, updated: null} : (t.emit(n.USER_UPDATE, s, i), {old: s, updated: i})
            }
        }
    }, function (e, t, i) {
        "use strict";
        const s = i(1), n = i(28), {Events: r} = i(0);
        e.exports = class VoiceStateUpdate extends s {
            handle(e) {
                const t = this.client, i = t.guilds.cache.get(e.guild_id);
                if (i) {
                    const s = i.voiceStates.cache.has(e.user_id) ? i.voiceStates.cache.get(e.user_id)._clone() : new n(i, {user_id: e.user_id}),
                        o = i.voiceStates.add(e);
                    let a = i.members.cache.get(e.user_id);
                    a && e.member ? a._patch(e.member) : e.member && e.member.user && e.member.joined_at && (a = i.members.add(e.member)), a && a.user.id === t.user.id && (t.emit("debug", "[VOICE] received voice state update: " + JSON.stringify(e)), t.voice.onVoiceStateUpdate(e)), t.emit(r.VOICE_STATE_UPDATE, s, o)
                }
            }
        }
    }, function (e, t, i) {
        "use strict";
        const s = i(1), {Events: n} = i(0);
        e.exports = class GuildEmojiCreateAction extends s {
            handle(e, t) {
                const i = e.emojis.add(t);
                return this.client.emit(n.GUILD_EMOJI_CREATE, i), {emoji: i}
            }
        }
    }, function (e, t, i) {
        "use strict";
        const s = i(1), {Events: n} = i(0);
        e.exports = class GuildEmojiDeleteAction extends s {
            handle(e) {
        ...
        "use strict";
        const s = i(1), {Events: n} = i(0);
        e.exports = class GuildEmojiUpdateAction extends s {
            handle(e, t) {
                const i = e._update(t);
                return this.client.emit(n.GUILD_EMOJI_UPDATE, i, e), {emoji: e}
            }
        }
    }, function (e, t, i) {
        "use strict";
        const s = i(1);
        e.exports = class GuildEmojisUpdateAction extends s {
            handle(e) {
                ...
                for (const s of e.emojis) {
                    ...
                    e ? (i.delete(s.id), e.equals(s) || this.client.actions.GuildEmojiUpdate.handle(e, s)) : this.client.actions.GuildEmojiCreate.handle(t, s)
                }
                for (const e of i.values()) this.client.actions.GuildEmojiDelete.handle(e)
            }
        }
    }, function (e, t, i) {
        "use strict";
        const s = i(1);
        e.exports = class GuildRolesPositionUpdate extends s {
            handle(e) {
                const t = this.client.guilds.cache.get(e.guild_id);
                if (t) for (const i of e.roles) {
                    const e = t.roles.cache.get(i.id);
                    e && (e.rawPosition = i.position)
                }
                return {guild: t}
            }
        }
        ...
        "use strict";
        const s = i(1);
        e.exports = class GuildChannelsPositionUpdate extends s {
            handle(e) {
                const t = this.client.guilds.cache.get(e.guild_id);
                if (t) for (const i of e.channels) {
        ...
        "use strict";
        const s = i(1), {Events: n} = i(0);
        e.exports = class GuildIntegrationsUpdate extends s {
            handle(e) {
                const t = this.client, i = t.guilds.cache.get(e.guild_id);
        ...
        "use strict";
        const s = i(1), {Events: n} = i(0);
        e.exports = class WebhooksUpdate extends s {
            handle(e) {
                const t = this.client, i = t.channels.cache.get(e.channel_id);
        ...
        "use strict";
        const s = i(15), n = i(163), r = i(93), {Error: o} = i(3),
            a = i(2), {Events: c, ShardEvents: l, Status: h, WSCodes: u, WSEvents: d} = i(0), p = i(4),
            f = [d.READY, d.RESUMED, d.GUILD_CREATE, d.GUILD_DELETE, d.GUILD_MEMBERS_CHUNK, d.GUILD_MEMBER_ADD, d.GUILD_MEMBER_REMOVE],
            m = Object.keys(u).slice(1).map(Number), g = [1e3, 4006, 4007];
        e.exports = class WebSocketManager extends s {
            constructor(e) {
            ...
            async connect() {
                const e = new o(u[4004]), {url: t, shards: i, session_start_limit: s} = await this.client.api.gateway.bot.get().catch(t => {
                    throw 401 === t.httpStatus ? e : t
                });
                this.sessionStartLimit = s;
                const {total: r, remaining: a, reset_after: c} = s;
                ...
                return "auto" === l && (this.debug("Using the recommended shard count provided by Discord: " + i), this.totalShards = this.client.options.shardCount = i, l = this.client.options.shards = Array.from({length: i}, (e, t) => t)), this.totalShards = l.length, this.debug("Spawning shards: " + l.join(", ")), this.shardQueue = new Set(l.map(e => new n(this, e))), await this._handleSessionLimit(a, c), this.createShards()
            }
            ...
            async createShards() {
                ...
                this.shardQueue.delete(e), e.eventsAttached || (e.on(l.ALL_READY, t => {
                    ...
                    if (1e3 === t.code ? this.destroyed : m.includes(t.code)) return this.client.emit(c.SHARD_DISCONNECT, t, e.id), void this.debug(u[t.code], e);
                    g.includes(t.code) && (e.sessionID = void 0), this.client.emit(c.SHARD_RECONNECTING, e.id), this.shardQueue.add(e), e.sessionID ? (this.debug("Session ID is present, attempting an immediate reconnect...", e), this.reconnect(!0)) : (e.destroy({
                        reset: !0,
                        emit: !1,
                        log: !1
                    }), this.reconnect())
                ...
                try {
                    ...
                    if (t && t.code && m.includes(t.code)) throw new o(u[t.code]);
                    if (t && !t.code) throw t;
            ...
            async _handleSessionLimit(e, t) {
                if (void 0 === e && void 0 === t) {
                    const {session_start_limit: i} = await this.client.api.gateway.bot.get();
                    this.sessionStartLimit = i, e = i.remaining, t = i.reset_after, this.debug(`Session Limit Information\n    Total: ${i.total}\n    Remaining: ${e}`)
                }
                e || (this.debug(`Exceeded identify threshold. Will attempt a connection in ${t}ms`), await p.delayFor(t))
            }

            handlePacket(e, t) {
                if (e && this.status !== h.READY && !f.includes(e.t)) return this.packetQueue.push({
                    packet: e,
                    shard: t
                }), !1;
        ...
        "use strict";
        const s = i(15), n = i(92), {browser: r, Status: o, Events: a, ShardEvents: c, OPCodes: l, WSEvents: h} = i(0),
        ...
        e.exports = class WebSocketShard extends s {
            constructor(e, t) {
            ...
            connect() {
                ...
                return this.connection && this.connection.readyState === n.OPEN && this.status === o.READY ? Promise.resolve() : new Promise((i, s) => {
                    const r = () => {
            ...
            onMessage({data: e}) {
                ...
                if (e instanceof ArrayBuffer && (e = new Uint8Array(e)), p) {
                    const i = e.length,
                        s = i >= 4 && 0 === e[i - 4] && 0 === e[i - 3] && 255 === e[i - 2] && 255 === e[i - 1];
                    if (this.inflate.push(e, s && p.Z_SYNC_FLUSH), !s) return;
                    t = this.inflate.result
                } else t = e;
                try {
                    i = n.unpack(t), this.manager.client.emit(a.RAW, i, this.id), i.op === l.DISPATCH && this.manager.emit(i.t, i.d, this.id)
                } catch (e) {
                ...
                if (e) {
                    ...
                    switch (e.s > this.sequence && (this.sequence = e.s), e.op) {
                        case l.HELLO:
                            ...
                            break;
                        case l.RECONNECT:
                            this.debug("[RECONNECT] Discord asked us to reconnect"), this.destroy({closeCode: 4e3});
                            break;
            ...
            destroy({closeCode: e = 1e3, reset: t = !1, emit: i = !0, log: s = !0} = {}) {
                if (s && this.debug(`[DESTROY]\n    Close Code    : ${e}\n    Reset         : ${t}\n    Emit DESTROYED: ${i}`), this.setHeartbeatTimer(-1), this.setHelloTimeout(-1), this.connection) if (this.connection.readyState === n.OPEN) this.connection.close(e); else {
                    this.debug("WS State: " + d[this.connection.readyState]), this._cleanupConnection();
                    try {
                        this.connection.close(e)
                    } catch {
                    }
                    i && this._emitDestroyed()
                } else i && this._emitDestroyed();
        ...
        var s = {
            "./CHANNEL_CREATE.js": 168,
            "./CHANNEL_DELETE.js": 169,
            "./CHANNEL_PINS_UPDATE.js": 170,
            "./CHANNEL_UPDATE.js": 171,
            "./GUILD_BAN_ADD.js": 172,
            "./GUILD_BAN_REMOVE.js": 173,
            "./GUILD_CREATE.js": 174,
            "./GUILD_DELETE.js": 175,
            "./GUILD_EMOJIS_UPDATE.js": 176,
            "./GUILD_INTEGRATIONS_UPDATE.js": 177,
            "./GUILD_MEMBERS_CHUNK.js": 178,
            "./GUILD_MEMBER_ADD.js": 179,
            "./GUILD_MEMBER_REMOVE.js": 180,
            "./GUILD_MEMBER_UPDATE.js": 181,
            "./GUILD_ROLE_CREATE.js": 182,
            "./GUILD_ROLE_DELETE.js": 183,
            "./GUILD_ROLE_UPDATE.js": 184,
            "./GUILD_UPDATE.js": 185,
            "./INVITE_CREATE.js": 186,
            "./INVITE_DELETE.js": 187,
            "./MESSAGE_CREATE.js": 188,
            "./MESSAGE_DELETE.js": 189,
            "./MESSAGE_DELETE_BULK.js": 190,
            "./MESSAGE_REACTION_ADD.js": 191,
            "./MESSAGE_REACTION_REMOVE.js": 192,
            "./MESSAGE_REACTION_REMOVE_ALL.js": 193,
            "./MESSAGE_REACTION_REMOVE_EMOJI.js": 194,
            "./MESSAGE_UPDATE.js": 195,
            "./PRESENCE_UPDATE.js": 196,
            "./READY.js": 197,
            "./RESUMED.js": 198,
            "./TYPING_START.js": 199,
            "./USER_UPDATE.js": 200,
            "./VOICE_SERVER_UPDATE.js": 201,
            "./VOICE_STATE_UPDATE.js": 202,
            "./WEBHOOKS_UPDATE.js": 203,
            "./index.js": 93
        };
        ...
        const {Events: s} = i(0);
        e.exports = (e, {d: t}) => {
            const i = e.channels.cache.get(t.channel_id), n = new Date(t.last_pin_timestamp);
            i && !Number.isNaN(n.getTime()) && (i.lastPinTimestamp = n.getTime() || null, e.emit(s.CHANNEL_PINS_UPDATE, i, n))
        }
    }, function (e, t, i) {
        "use strict";
        const {Events: s} = i(0);
        e.exports = (e, t) => {
            ...
            i && n && e.emit(s.CHANNEL_UPDATE, i, n)
        }
    }, function (e, t, i) {
        "use strict";
        const {Events: s} = i(0);
        e.exports = (e, {d: t}) => {
            const i = e.guilds.cache.get(t.guild_id), n = e.users.add(t.user);
            i && n && e.emit(s.GUILD_BAN_ADD, i, n)
        }
    }, function (e, t, i) {
        "use strict";
        e.exports = (e, t) => {
        ...
        "use strict";
        const {Events: s, Status: n} = i(0);
        e.exports = async (e, {d: t}, i) => {
            let r = e.guilds.cache.get(t.id);
            r ? r.available || t.unavailable || (r._patch(t), e.ws.status === n.READY && e.options.fetchAllMembers && await r.members.fetch().catch(t => e.emit(s.DEBUG, `Failed to fetch all members: ${t}\n${t.stack}`))) : (t.shardID = i.id, r = e.guilds.add(t), e.ws.status === n.READY && (e.options.fetchAllMembers && await r.members.fetch().catch(t => e.emit(s.DEBUG, `Failed to fetch all members: ${t}\n${t.stack}`)), e.emit(s.GUILD_CREATE, r)))
        }
    }, function (e, t, i) {
        "use strict";
        e.exports = (e, t) => {
        ...
        "use strict";
        const s = i(2), {Events: n} = i(0);
        e.exports = (e, {d: t}) => {
            const i = e.guilds.cache.get(t.guild_id);
            if (!i) return;
            const r = new s;
            for (const e of t.members) r.set(e.user.id, i.members.add(e));
            if (t.presences) for (const e of t.presences) i.presences.add(Object.assign(e, {guild: i}));
            e.emit(n.GUILD_MEMBERS_CHUNK, r, i, {count: t.chunk_count, index: t.chunk_index, nonce: t.nonce})
        }
    }, function (e, t, i) {
        "use strict";
        const {Events: s, Status: n} = i(0);
        e.exports = (e, {d: t}, i) => {
            ...
            if (r) {
                ...
                i.status === n.READY && e.emit(s.GUILD_MEMBER_ADD, o)
            }
        }
    }, function (e, t, i) {
        "use strict";
        ...
        e.exports = (e, {d: t}, i) => {
            ...
            if (r) {
                ...
                if (o) {
                    const r = o._update(t);
                    i.status === s.READY && e.emit(n.GUILD_MEMBER_UPDATE, r, o)
                }
            }
        }
    }, function (e, t, i) {
        ...
        e.exports = (e, t) => {
            ...
            i && n && e.emit(s.MESSAGE_UPDATE, i, n)
        }
    }, function (e, t, i) {
        "use strict";
        e.exports = (e, t) => {
        ...
        e.exports = (e, {d: t}, n) => {
            if (e.user) e.user._patch(t.user); else {
                s || (s = i(94));
                const n = new s(e, t.user);
                e.user = n, e.users.cache.set(n.id, n)
            }
            for (const i of t.guilds) i.shardID = n.id, e.guilds.add(i);
            n.checkReady()
        }
    }, function (e, t, i) {
        "use strict";
        ...
        e.exports = (e, t, i) => {
            ...
            e.emit(s.SHARD_RESUME, i.id, n)
        }
    }, function (e, t, i) {
        "use strict";
        const {Events: s} = i(0), n = ["dm", "text", "news"];
        ...
        e.exports = (e, {d: t}) => {
            const i = e.channels.cache.get(t.channel_id), o = e.users.cache.get(t.user_id),
                a = new Date(1e3 * t.timestamp);
            if (i && o) {
                if (!n.includes(i.type)) return void e.emit(s.WARN, `Discord sent a typing packet to a ${i.type} channel ${i.id}`);
                if (i._typing.has(o.id)) {
                    const t = i._typing.get(o.id);
                    t.lastTimestamp = a, t.elapsedTime = Date.now() - t.since, e.clearTimeout(t.timeout), t.timeout = r(i, o)
                } else {
